...
Cerulein-induced pancreatitis (CIP) is the standard rodent model of acute pancreatitis. Supramaximal cerulein (a CCK analogue) hyperstimulates pancreatic acinar cells, causing premature zymogen activation, acinar cell necrosis, edema, and systemic inflammation.
...
CIP models the sterile-inflammatory trajectory of human acute pancreatitis, where the extent of necrosis predicts organ failure. It is therefore a key in vivo testbed for anti-necroptotic agents such as [[Necrostatin-1s]].
