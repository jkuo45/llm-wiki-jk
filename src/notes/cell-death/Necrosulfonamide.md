...
url: #
source: #
aliases: [NSA, Necrosulfonamide (NSA)]
---

# Necrosulfonamide

**Necrosulfonamide** (NSA) is a small-molecule inhibitor of [[MLKL]] that blocks its membrane translocation and pore formation, arresting [[Necroptosis]] at the terminal executor step. Critical caveat: NSA also blocks [[Gasdermin D]] pore formation, so NSA rescue alone cannot separate necroptosis from [[Pyroptosis]] — pair it with [[Necrostatin-1]]/GSK872 (necroptosis-specific) versus caspase-1/NLRP3 inhibitors (pyroptosis-specific) in the death-dissection panel.
...
- [[Necroptosis]] — terminal-executor blockade; completes the Nec-1/GSK872/NSA dissection triad.
- [[MLKL]] — the direct target; translocation/pore blockade downstream of phosphorylation.
- [[Gasdermin D]] — off-target pore blockade creating the necroptosis/pyroptosis ambiguity.
- [[Pyroptosis]] — the confounded alternative when NSA alone rescues.
- [[Necrostatin-1]] — upstream partner inhibitor for clean necroptosis attribution.
