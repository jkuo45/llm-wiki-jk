...
**MFN2** (Mitofusin 2) is a dynamin-related GTPase of the [[Outer Mitochondrial Membrane|outer mitochondrial membrane]] that mediates [[Mitochondrial Fusion|mitochondrial fusion]] and, uniquely among the mitofusins, also localizes to the [[Endoplasmic Reticulum|ER]] membrane where it tethers ER to [[Mitochondria|mitochondria]] to enable [[Calcium|mitochondrial calcium uptake]]. Heterozygous loss-of-function mutations in *MFN2* cause [[Charcot-Marie-Tooth Disease Type 2A|CMT2A]], the most common axonal form of Charcot–Marie–Tooth neuropathy.

## Structure and Domains

Like [[MFN1|MFN1]], MFN2 has an N-terminal GTPase domain, HR1 and HR2 helical repeats, and a single transmembrane domain (per the updated topology) with HR2 in the [[Mitochondrial Intermembrane Space|intermembrane space]].

## Functions

- **Outer-membrane fusion** — oligomerizes with [[MFN1|MFN1]] to tether and fuse mitochondria.
- **ER–mitochondria tethering** — MFN2 on the ER bridges the two organelles, coupling [[Calcium|calcium]] transfer.
- **Axonal transport** — MFN2 interacts with [[Miro]] and [[Milton]], forming a complex that links mitochondria to [[Kinesin|kinesin motors]] for axonal trafficking of mitochondria.
...
- **[[Charcot-Marie-Tooth Disease Type 2A]]** — heterozygous missense *MFN2* mutations (e.g., T105M, R94W) impair axonal mitochondrial transport via the Miro/Milton/Kinesin complex, causing distal limb sensory/motor loss; some alleles overlap with [[Dominant Optic Atrophy]].
- **[[Cancer]]** — MFN2 loss correlates with increased fission and tumor aggressiveness; its overexpression or restoring fusion can suppress breast cancer growth.
...
- [[MFN1]] — Partner OMM fusion GTPase.
- [[Mitochondrial Fusion]] — MFN2 drives outer-membrane fusion.
- [[Endoplasmic Reticulum]] — MFN2 tethers ER to mitochondria.
- [[Calcium]] — MFN2-mediated tethering enables mitochondrial Ca2+ uptake.
- [[Miro]] / [[Milton]] / [[Kinesin]] — Transport complex disrupted in CMT2A.
- [[JNK]] — Phosphorylates MFN2 for stress-induced degradation.
