...
> STING is transcriptionally suppressed by estrogen: E₂-bound [[Estrogen Receptor|ERα]] recruits [[HDAC3]] to the STING/`TMEM173` promoter, deacetylating histones and reducing STING expression (Chen et al., *Cancers* 2022). This makes the [[cGAS-STING Pathway|cGAS–STING→SASP]] cascade a sex-sensitive amplifier: aged males show higher cGAS/STING activity (lower mtDNA clearance capacity; Feng et al., *JCI Insight* 2024), while premenopausal females are protected by ERα–HDAC3-mediated repression.
