---
title: Proline
description: Non-essential amino acid that serves as the major nitrogen donor for polyamine synthesis. Proline levels decline with age; supplementation extends lifespan of yeast and C. elegans, and proline may promote longevity through ROS scavenging and effects on senescence.
created: 2026-07-31
updated: 2026-07-31
tags:
  - chemical-compound
...
**Proline** is a non-essential amino acid with a unique cyclic structure that constrains protein backbone conformation. It serves as the major nitrogen donor for synthesizing [[Polyamine|polyamines]] and plays roles in collagen stability, redox balance, and cellular stress responses. Proline levels in plasma, muscle, and skin are reduced in aged organisms, and its levels decline in senescent cells.
...
- Proline supplementation extends lifespan of yeast and *C. elegans*
- Proline levels are reduced in senescent cells, and supplementation decreases senescence of mesenchymal stem cells in culture
- Proline may promote lifespan through its ability to scavenge [[Reactive Oxygen Species|reactive oxygen species (ROS)]]

> [!info] Proline and Polyamines
> Proline serves as the major nitrogen donor for synthesizing polyamines, including [[Spermidine]], which are themselves implicated in autophagy induction and longevity.
...
- [[_document_ - The-hallmarks-of-protein-and-amino-acid-restriction|The Hallmarks of Protein and Amino Acid Restriction in Aging and Longevity]]
  - Reviews the emerging evidence that dietary proline and the proline catabolic pathway impact aging and senescence.

## Connections

- [[Polyamine]] — Proline is the major nitrogen donor for polyamine synthesis
- [[Spermidine]] — A polyamine synthesized from proline-derived nitrogen; linked to autophagy and longevity
- [[Mitochondria]] — Proline catabolism feeds the electron transport chain; pathway impairment shortens lifespan
