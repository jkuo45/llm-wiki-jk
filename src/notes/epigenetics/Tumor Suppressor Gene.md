...
- [[Tumor Suppressor Gene]]: A **Tumor Suppressor Gene** (TSG) encodes a protein that protects cells from neoplastic transformation.
- [[Oncogene]]: Unlike oncogenes (which promote proliferation when mutated or overexpressed), TSGs suppress tumor formation by regula...
- [[Apoptosis]]: Unlike [[Oncogene|oncogenes]] (which promote proliferation when mutated or overexpressed), TSGs suppress tumor format...
- [[DNA Repair]]: Unlike [[Oncogene|oncogenes]] (which promote proliferation when mutated or overexpressed), TSGs suppress tumor format...
- [[Senescence]]: Unlike [[Oncogene|oncogenes]] (which promote proliferation when mutated or overexpressed), TSGs suppress tumor format...
- [[Knudson Two-Hit Hypothesis]]: The Knudson two-hit hypothesis — requiring both alleles to be inactivated — applies to classical TSGs like [[RB1]] and 
- [[RB1]]: The [[Knudson Two-Hit Hypothesis|Knudson two-hit hypothesis]] — requiring both alleles to be inactivated — applies to...
- [[p53]]: The [[Knudson Two-Hit Hypothesis|Knudson two-hit hypothesis]] — requiring both alleles to be inactivated — applies to...
- [[Cancer]]: Inactivation of TSGs in Cancer occurs at approximately equal frequency through: - **Genetic mutation** (point mutatio...
- [[CpG Island]]: - **Epigenetic silencing** (promoter CpG island hypermethylation).
- [[H3K27ac]]: - **Histone modifications** (loss of H3K27ac, gain of [[H3K27me3]] via [[Polycomb Group Proteins|PRC2]]).
- [[H3K27me3]]: - **Histone modifications** (loss of [[H3K27ac]], gain of H3K27me3 via [[Polycomb Group Proteins|PRC2]]).
- [[Polycomb Group Proteins]]: - **Histone modifications** (loss of [[H3K27ac]], gain of [[H3K27me3]] via PRC2).
- [[Epigenetic Modifiers]]: Epigenetic TSG silencing is reversible — unlike genetic inactivation — making it a therapeutic target for epidrugs.
- [[CDKN2A]]: | TSG | Cancer Type | Mechanism | Epidrug Response | |---|---|---|---| | CDKN2A (p16^INK4a^) | Melanoma, pancreatic, ...
- [[Decitabine]]: | TSG | Cancer Type | Mechanism | Epidrug Response | |---|---|---|---| | [[CDKN2A]] (p16^INK4a^) | Melanoma, pancreat...
- [[CDH1]]: | TSG | Cancer Type | Mechanism | Epidrug Response | |---|---|---|---| | [[CDKN2A]] (p16^INK4a^) | Melanoma, pancreat...
- [[5-Azacytidine]]: | TSG | Cancer Type | Mechanism | Epidrug Response | |---|---|---|---| | [[CDKN2A]] (p16^INK4a^) | Melanoma, pancreat...
- [[HDACi]]: | TSG | Cancer Type | Mechanism | Epidrug Response | |---|---|---|---| | [[CDKN2A]] (p16^INK4a^) | Melanoma, pancreat...
- [[MLH1]]: | TSG | Cancer Type | Mechanism | Epidrug Response | |---|---|---|---| | [[CDKN2A]] (p16^INK4a^) | Melanoma, pancreat...
- [[5-FU]]: | TSG | Cancer Type | Mechanism | Epidrug Response | |---|---|---|---| | [[CDKN2A]] (p16^INK4a^) | Melanoma, pancreat...
- [[BRCA1]]: | TSG | Cancer Type | Mechanism | Epidrug Response | |---|---|---|---| | [[CDKN2A]] (p16^INK4a^) | Melanoma, pancreat...
- [[PARP inhibitors]]: | TSG | Cancer Type | Mechanism | Epidrug Response | |---|---|---|---| | [[CDKN2A]] (p16^INK4a^) | Melanoma, pancreat...
...
- [[CRISPR]]: **Epigenetic editing:** CRISPR-dCas9-[[TET1]] to demethylate specific TSG promoters.
- [[TET1]]: **Epigenetic editing:** [[CRISPR]]-dCas9-TET1 to demethylate specific TSG promoters.
- [[Panobinostat]]: **Transcriptional reactivation:** [[HDAC inhibitors]] (e.g., Panobinostat) to open silenced TSG chromatin.
