...
- [[_document_ - Cellular senescence and SASP in tumor progression and therapeutic opportunities|Dong et al. 2024 Senescence and SASP in Tumors]]
  ...
  - [[_document_ - Acid_ceramidase_modulates_the_lipid_profile_and_ex|Acid ceramidase modulates the lipid profile… (Soriano-Castell et al., 2026)]]
    - Cell Death and Disease paper showing [[Acid ceramidase]] (ASAH1) is over-expressed 5- to 20-fold in replicatively [[Senescent Cells|senescent]] WI-38 fibroblasts, driving a pro-ferroptotic membrane [[Lipid Metabolism|lipid profile]] (elevated PL-[[PUFA|PUFAs]]) that sensitizes cells to [[Ferroptosis]] **independently of [[GPX4]]/[[Glutathione|GSH]] and [[Iron|iron]]**, and is transmitted to neighbors via [[SASP]] cytokines [[IL-6]]/[[IL-8]]. Core entities: [[Acid ceramidase]], [[ACSL4]], [[Ceramide]], [[Phospholipid]], [[Senescent Cells]].
...
| [[Acid ceramidase]]                                  | 24_July_2026 12:00 PM PDT | Enzyme                |      7      |      0      | Over-expressed in replicative senescence; cleaves [[Ceramide|ceramide]] to free fatty acids that enrich membrane PL-[[PUFA|PUFAs]], creating a pro-[[Ferroptosis|ferroptotic]] profile; a tractable [[Senolytic|senolytic]] target (inhibitors exist). Cross-topic, consolidated in `_link/`. |
...
| [[Tumor Microenvironment]]                           | 13_July_2026 12:00 PM PDT | Biological Structure   |      7      |      0      | Cross-topic entity; SASP reshapes TME via immunosuppression, angiogenesis, and EMT; canonical hub in `notes/cancer/`.         |
