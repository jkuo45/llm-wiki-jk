...
- Primary roles: Master regulator of [[Metabolism|metabolism]], stress resistance, and [[Longevity|longevity]]. Deacetylates histones (e.g., H3K9, H3K26) and many non-histone proteins ([[p53]], [[FOXO|FOXO]], [[NF-κB|NF-κB]], [[PGC-1α]], etc.).
...
- Key functions: Maintains genomic stability, [[Telomere Attrition|telomere function]], [[DNA Repair|DNA repair]] (base excision repair), regulates glycolysis and lipid [[Metabolism|metabolism]] (represses [[HIF-1α|HIF-1α]], [[SREBP1|SREBP]]), [[Inflammation|inflammation]] control.
...
### 1. Mono-ADP-ribosyltransferase activity
...
### 2. Deacylase activity (general term)

Deacylase means the enzyme removes an acyl group (a fatty-acid-like chain or other carboxylic acid derivative) that is attached to a lysine residue on a protein. This is usually coupled with the hydrolysis of [[NAD+]].  
The specific deacylase activities listed are subtypes based on the exact acyl group being removed:
...
In one key longevity study with the [[CD38]] inhibitor [[CD38 inhibitor 78c|78c]] in naturally aged mice:
...
[[CD38]] is a major therapeutic target in [[Cancer|cancer]], primarily through monoclonal antibodies (mAbs) like [[Daratumumab|daratumumab]] and [[Isatuximab|isatuximab]] in [[Multiple Myeloma|multiple myeloma]] (MM), with expanding roles in modulating the [[Tumor Microenvironment|tumor microenvironment]] ([[Tumor Microenvironment|TME]]) for solid tumors and novel approaches like small-molecule inhibitors, CAR-T, and radioligand therapy.
...
They are transformative in [[Multiple Myeloma|MM]]:
...
[[CD38]] targeting is being explored to remodel the immunosuppressive [[Tumor Microenvironment|TME]]:
...
- CAR-T and cell therapies: [[CD38]] CAR-T for [[Multiple Myeloma|MM]]; [[CD38]] knockout in CAR-T cells to reduce exhaustion.
...
- Resistance: Downregulation of [[CD38]], trogocytosis, or compensatory mechanisms in [[Multiple Myeloma|MM]].
