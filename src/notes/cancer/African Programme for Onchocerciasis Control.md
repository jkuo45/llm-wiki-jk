...
The **African Programme for Onchocerciasis Control (APOC)** was a World Health Organization-coordinated partnership launched in 1995 to eliminate [[Onchocerciasis]] (river blindness) as a public health problem across endemic African countries. It succeeded the earlier Onchocerciasis Control Programme (OCP) and pioneered the **community-directed treatment with ivermectin (CDTI)** strategy that became a global template for neglected tropical disease (NTD) control.

## Scope & Strategy

Onchocerciasis is caused by the filarial nematode *Onchocerca volvulus*, transmitted by blackfly (*Simulium*) vectors. APOC focused on breaking transmission through mass drug administration of [[Ivermectin]] (donated by [[Merck & Co. Inc]]), delivered annually to endemic communities. Rather than relying on fixed health facilities, APOC trained community volunteers to distribute the drug, improving coverage in remote regions. Mapping used rapid epidemiological assessment and nodule prevalence surveys to target the ~19 endemic countries.

## Cancer-Relevant Linkages
...
- [[Ivermectin]]: Primary intervention drug distributed by APOC.
- [[World Health Organization]]: Coordinating agency.
- [[Merck & Co. Inc]]: Donor of ivermectin.
- [[Community-directed treatment]]: Delivery model pioneered by APOC.
- [[Cancer]]: Equity and repurposing linkages to oncology.
- [[Neglected Tropical Diseases]]: Broader disease category addressed.
