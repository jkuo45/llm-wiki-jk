...
description: The tumor microenvironment (TME) is the complex cellular and acellular milieu surrounding tumor cells, comprising stromal fibroblasts, immune cells, vasculature, and extracellular matrix that collectively influence cancer progression, immune evasion, and therapeutic response.
created: 2026-07-10
updated: 2026-07-10
tags:
  - biological-process
...
The **tumor microenvironment (TME)** is the complex ecosystem of non-malignant cells, soluble factors, and extracellular matrix (ECM) that surrounds and interacts with tumor cells. It plays a critical role in shaping cancer progression, immune evasion, drug resistance, and [[Metastasis]]. The TME includes cancer-associated fibroblasts (CAFs), tumor-associated macrophages (TAMs), myeloid-derived suppressor cells (MDSCs), endothelial cells, pericytes, and a dense remodeled ECM.
...
- **T Lymphocytes**: CD8+ T cells can kill tumor cells but are often functionally exhausted or excluded from the TME.

### Acellular Components

- **Extracellular Matrix (ECM)**: Collagens, fibronectin, laminin, and proteoglycans that provide structural and signaling support. Remodeled by [[MMP-9|matrix metalloproteinases (MMPs)]].
- **Soluble Factors**: Growth factors ([[VEGF]], [[HGF]], [[bFGF]]), cytokines ([[IL-6]], [[IL-8]], [[TNFα]]), and chemokines ([[CCL2]], [[CXCL1]]) that drive paracrine signaling.
...
- **Senolytics** ([[Senolytic Therapy|Senolytics]]): Clear senescent cells from the TME, eliminating SASP sources
...
- **Immune checkpoint inhibitors**: Restore anti-tumor immunity in the TME
...
- [[Senolytic Therapy|Senolytics]] — Clear senescent cells from the TME
- [[Senomorphic Therapy]] — Suppress SASP in the TME
...
- [[tumour microenvironment]] — Related entity (lowercase variant in notes)
