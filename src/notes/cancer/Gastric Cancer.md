...
Gastric cancer (stomach cancer) is a malignant tumor of the gastric epithelium and remains one of the leading causes of cancer mortality worldwide, particularly in East Asia, Eastern Europe, and parts of Latin America. The vast majority are adenocarcinomas arising from chronic inflammation of the gastric mucosa.

## Etiology & Pathophysiology

The dominant etiological factors are infection with *Helicobacter pylori*, dietary carcinogens (high salt, smoked foods, low fruit/vegetable intake), smoking, and hereditary syndromes (e.g., CDH1 germline mutations causing diffuse [[Hereditary Diffuse Gastric Cancer]]). A metaplasia–dysplasia–carcinoma sequence driven by [[Inflammation]] and oxidative DNA damage underlies intestinal-type tumors. Molecularly, gastric cancer is heterogeneous, encompassing EBV-positive, microsatellite-instable, genomically stable, and chromosomal-instable subtypes (TCGA classification). Key drivers include [[HER2]] amplification, [[MET]] alterations, [[p53]] loss, and activation of the [[Wnt]]/β-catenin and [[PI3K]]/[[Akt]] pathways.

## Clinical Presentation & Biomarkers

Early disease is often asymptomatic; advanced symptoms include dyspepsia, weight loss, early satiety, and anemia. Diagnosis relies on endoscopy with biopsy and [[Helicobacter pylori]] testing. Biomarkers guiding therapy include HER2 (for [[trastuzumab]]), PD-L1 (for immune checkpoint inhibitors), and MSI status. [[Circulating tumor DNA]] and serum pepsinogen are investigational tools.
...
List of documents that mention this entity
  ...
  - [[_document_ - Caspase|Caspase]]
    - Ser163 | Prevents degradation | Hepatocellular Carcinoma, Lymphoma | | Apaf-1 | Loss in Melanoma, Colon Cancer, Gastric Cancer, Bladder Cancer; Amplification in glioblastoma | RSK | Ser268 | I
  ...
  - [[_document_ - Ivermectin, a potential anticancer drug derived from an antiparasitic drug|Ivermectin, a potential anticancer drug derived from an antiparasitic drug]]
    - Digestive system cancer Gastric Cancer is one of the most common malignant tumors worldwide. In the past year, more than one million patients with gastric cancer have been diagnosed worldwide \[\].

  - [[_document_ - sirtuins in health and disease s41392-022-01257-8|sirtuins in health and disease s41392-022-01257-8]]
    - However, SIRT5 could enhance autophagy in Gastric Cancer cells via the AMPK/mTOR pathway. Additionally, SIRT5-induced deacetylation of lactate dehydrogenase B triggers hyperactivation of autophagy; a key event in tumorigenesis.


## Connections

- [[Ivermectin]]: Inhibits proliferation in YAP1-high gastric cancer models.
- [[YAP1]]: Determinant of ivermectin sensitivity in this tumor.
- [[HER2]]: Targetable driver and biomarker.
- [[Inflammation]]: H. pylori–driven precursor of carcinogenesis.
- [[Chemotherapy]]: Standard perioperative treatment.
- [[transtuzumab]]: Anti-HER2 antibody used in advanced disease.
- [[VEGF]]: Angiogenic target (ramucirumab).
- [[Metastasis]]: Peritoneal dissemination is a common lethal pattern.

## Linking Summary

- New links added: [[Ivermectin]], [[YAP1]], [[HER2]], [[Inflammation]], [[Chemotherapy]], [[trastuzumab]], [[VEGF]], [[Metastasis]], [[Helicobacter pylori]], [[p53]], [[PI3K]], [[Akt]], [[Wnt]], [[MET]], [[Circulating tumor DNA]]
