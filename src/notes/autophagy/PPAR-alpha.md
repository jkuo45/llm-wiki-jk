...
Peroxisome proliferator-activated receptor alpha, a nuclear receptor protein that functions as a transcription factor regulating the expression of genes involved in [[Metabolism|lipid metabolism]].

## Structure & Function

PPARα is a nuclear receptor (NR1C1) that forms heterodimers with [[RXR]] and binds to peroxisome proliferator response elements (PPREs). It is activated by fatty acids, fibrates (e.g., [[Fenofibrate]]), and synthetic agonists.
...
- [[Metabolism]]: Peroxisome proliferator-activated receptor alpha, a nuclear receptor protein that functions as a transcription factor...
- [[RXR]]: PPARα is a nuclear receptor (NR1C1) that forms heterodimers with RXR and binds to peroxisome proliferator response el...
- [[Fenofibrate]]: It is activated by fatty acids, fibrates (e.g., Fenofibrate), and synthetic agonists.
- [[Beta-Oxidation]]: PPARα is a master regulator of lipid metabolism, controlling Beta-Oxidation, [[Ketogenesis]], and [[Lipoprotein]] met...
- [[Ketogenesis]]: PPARα is a master regulator of lipid metabolism, controlling [[Beta-Oxidation]], Ketogenesis, and [[Lipoprotein]] met...
- [[Lipoprotein]]: PPARα is a master regulator of lipid metabolism, controlling [[Beta-Oxidation]], [[Ketogenesis]], and Lipoprotein met...
- [[Autophagy]]: It also induces Autophagy and [[Peroxisome]] proliferation.
- [[Peroxisome]]: It also induces [[Autophagy]] and Peroxisome proliferation.
