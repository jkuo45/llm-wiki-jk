...
created: 2026-08-30
updated: 2026-08-30
source: counterfactual + staged replay sims on graphify-out/graph.json, wiki-out/wiki-graph.json & web/public/data/edges.json (combined); scripts/04_node_analysis.py, 04_role_query.py, graphify CLI; web research (Cell, Nature, NEJM, Lancet, eLife, PNAS, FDA 2012-2026)
tags:
  - task-output
  - knowledge-graph
  - graph-metrics
