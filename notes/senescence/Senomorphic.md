---
title: Senomorphic
description: A senomorphic is an intervention that suppresses the senescence-associated secretory phenotype (SASP) and other detrimental features of senescent cells without necessarily inducing their death.
created: 2026-07-09
updated: 2026-07-09
tags:
...
> [!info] Senolytic vs. Senomorphic
> - **Senolytic** — kills [[Senescent Cells|senescent cells]] (e.g., [[Fisetin]], D+Q).
> - **Senomorphic** — dampens SASP / pro-inflammatory signaling without cell death (e.g., mTOR inhibitors, NF-κB inhibitors, some flavonoids at sub-senolytic doses).
...
## Connections
  ...
  - [[Fisetin]]: Exhibits both senolytic and senomorphic features.
   ...
   - [[Histone Variant]]: histone variant dynamics are senomorphic-relevant
   - [[LINE-1]]: NRTIs targeting LINE-1 reverse transcriptase are senomorphic
