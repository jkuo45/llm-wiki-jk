...
An **[[Epigenetic Clock]]** is a biochemical test that can be used to measure age. The test is based on [[DNA Methylation]] levels, which change in a predictable way as we get older. By measuring the methylation status of specific CpG sites in the genome, researchers can estimate an individual's "biological age," which may differ from their chronological age.

### 1. Mechanisms and Accuracy
Epigenetic clocks are among the most accurate biomarkers for aging. They typically involve algorithms (like the Horvath clock) that analyze a set of CpG sites across various tissues.
*   **Biological vs. Chronological Age:** If a person's biological age is higher than their chronological age (known as "epigenetic age acceleration"), they may be at a higher risk for age-related diseases and mortality.
