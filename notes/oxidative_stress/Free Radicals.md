...
Free radicals are atoms, molecules, or ions that have at least one unpaired valence electron. This unpaired electron makes them highly chemically reactive toward other substances, or even toward themselves. In biology they are the proximal agents of [[Oxidative Stress]] and initiators of chain reactions including [[Lipid Peroxidation]].

## Reactivity and Classification

Free radicals vary dramatically in half-life and target specificity. Oxygen-centered radicals ([[Reactive Oxygen Species|ROS]]) include [[Superoxide Radicals]] (t½ ~1–10 μs) and the exceedingly reactive [[Hydroxyl Radicals]] (t½ ~10⁻⁹ s), which react at diffusion-limited rates with any nearby molecule. Nitrogen-centered radicals, primarily [[Nitric Oxide]] (t½ ~1–5 s), are more selective and serve dual signaling and cytotoxic roles. Carbon-centered radicals (lipid alkyl radicals, L•) arise during [[Lipid Peroxidation]] as chain-propagating intermediates in the polyunsaturated fatty acids of [[Cell Membranes]]. Thiyl radicals (RS•) form from thiol oxidation and redox-cycle with [[Glutathione]] and protein thiols.
...
- [[Aging]]: The free-radical theory (Harman, 1956) links accrued damage to senescence.
- [[Fenton Reaction]]: Metal-catalyzed branching amplifies radical chains.
- [[DNA Damage]]: Radical attack on nucleic acids drives mutation and cancer.

## Linking Summary

- New links added: [[Reactive Oxygen Species]], [[Reactive Nitrogen Species]], [[Mitohormesis]], [[Sulforaphane]], [[Thiyl Radicals]]
- Suggested new entity notes to create: [[Peroxyl Radicals]], [[Mitohormesis]], [[Thiyl Radicals]]
- Strong connections to strengthen: [[Free Radicals]] ↔ [[Oxidative Stress]], [[Free Radicals]] ↔ [[Lipid Peroxidation]]
