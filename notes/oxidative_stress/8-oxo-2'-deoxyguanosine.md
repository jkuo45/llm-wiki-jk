...
tags: [oxidative_stress, biomarker, dna_damage]
---
...
In the nucleotide pool, **MTH1** (NUDT1) sanitizes oxidized dGTP, while **MUTYH** (MutY homolog) removes adenine misincorporated opposite 8-oxodG during replication. Biallelic mutations in MUTYH cause **MUTYH-associated polyposis** (MAP), a hereditary colorectal cancer syndrome characterized by an elevated frequency of G→T transversions in the [[APC]] gene.
...
- **[[Cardiovascular Disease]]**: Associated with [[Atherosclerosis]] severity, heart failure, and risk of major adverse cardiac events.
- **[[Diabetes Mellitus]]**: Elevated in type 2 diabetes, correlating with HbA1c and albuminuria.
