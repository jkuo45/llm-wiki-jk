...
The bis-allylic methylene groups (CH₂ groups flanked by two double bonds) in PUFAs are the primary targets of free radical attack. The relative oxidation rates increase exponentially with the number of bis-allylic positions: linoleic acid (18:2, n-6) = 1×, arachidonic acid (20:4, n-6) = 6×, docosahexaenoic acid (22:6, n-3) = 8×. This differential susceptibility has important implications for membrane composition and disease risk.

## Major PUFAs

- **Linoleic acid (LA, 18:2, n-6)**: Essential; precursor to arachidonic acid
- **Arachidonic acid (AA, 20:4, n-6)**: Precursor to eicosanoids (prostaglandins, leukotrienes, thromboxanes) and substrate for [[F2-Isoprostanes|F₂-isoprostane]] formation
- **Docosahexaenoic acid (DHA, 22:6, n-3)**: Enriched in the brain and retina; highly oxidizable
- **Eicosapentaenoic acid (EPA, 20:5, n-3)**: Anti-inflammatory eicosanoid precursor
