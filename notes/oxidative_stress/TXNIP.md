...
Under basal conditions, TXNIP is sequestered by binding to reduced [[Thioredoxin]] (TRX). Oxidative stress oxidizes TRX at its active-site cysteines (Cys32, Cys35), releasing TXNIP. Free TXNIP then translocates to the [[NLRP3 Inflammasome]], where it directly binds NLRP3 and triggers ASC oligomerization, caspase-1 activation, and [[IL-1b|IL-1β]]/IL-18 maturation. TXNIP is transcriptionally induced by glucose via [[ChREBP]]/[[MondoA]] factors, linking [[Diabetes Mellitus|hyperglycemia]] to IL-1β production in pancreatic β-cells.
