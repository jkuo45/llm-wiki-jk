...
type: entity
category: enzyme
aliases: [PHGPx, Phospholipid hydroperoxide glutathione peroxidase, Glutathione peroxidase 4]
database_ids:
  uniprot: P36969
  hgnc: HGNC:4556
created: 2026-07-04
...
**GPx4 (Glutathione Peroxidase 4, Phospholipid Hydroperoxide Glutathione Peroxidase, PHGPx)** is a selenium-dependent antioxidant enzyme that uniquely reduces complex lipid hydroperoxides within membranes and lipoproteins, functioning as the master negative regulator of [[notes/oxidative_stress/Ferroptosis|ferroptosis]].
...
Three GPx4 isoforms arise from alternative transcription start sites and N-terminal targeting sequences:
- **Mitochondrial GPx4 (mGPx4)**: Targeted to mitochondria via an N-terminal mitochondrial localization signal; essential for male fertility (structural role in sperm mitochondrial capsule).
- **Nuclear GPx4 (nGPx4)**: Expressed in spermatids; involved in chromatin condensation during spermatogenesis.
- **Cytosolic GPx4 (cGPx4)**: The predominant somatic isoform; protects against lipid peroxidation and ferroptosis.
...
- **[[notes/oxidative_stress/Ferroptosis]]**: GPx4 is the central brake on ferroptosis; its inactivation is sufficient to trigger ferroptotic cell death in most cell types.
