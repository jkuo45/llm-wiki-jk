...
- [[HDAC]] — enzymes that remove acetyl groups
- [[Sirtuins]] — NAD+-dependent deacetylases
- [[Acetyl-CoA]] — acetyl group donor
- [[Chromatin]] — acetylation alters chromatin structure
- [[Gene Expression]] — acetylation regulates transcription
- [[p53]] — acetylated to enhance DNA-binding activity
- [[NF-κB]] — acetylation modulates its transcriptional activity
- [[Epigenetics]] — acetylation is a key epigenetic mark
- [[Cancer]] — acetylation patterns are altered in cancer
- [[Aging]] — acetylation changes with age
- [[Metabolism]] — acetyl-CoA links metabolism to acetylation
