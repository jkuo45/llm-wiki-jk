...
The [[Fenton Reaction]] is a chemical process in which [[Iron]] (Fe²⁺) reduces hydrogen peroxide (H₂O₂) to generate the highly reactive hydroxyl radical (•OH), a potent [[notes/_link/Reactive Oxygen Species]]. In the brain, iron sequestered by [[Neuromelanin]] can participate in Fenton chemistry, contributing to [[Oxidative Stress]] and neurodegeneration in [[notes/_link/Parkinson's Disease]].

### Linking Summary:
- New links added: [[Iron]], [[notes/_link/Reactive Oxygen Species]], [[Neuromelanin]], [[Oxidative Stress]], [[notes/_link/Parkinson's Disease]]
...
The Fenton reaction is a catalytic process that involves the reaction of [[notes/_link/Hydrogen Peroxide]] with ferrous iron (Fe2+) to produce highly reactive [[Hydroxyl Radicals]].

## Chemical Mechanism

The classical Fenton reaction proceeds as: Fe²⁺ + H₂O₂ → Fe³⁺ + •OH + OH⁻. The hydroxyl radical (•OH) produced is among the most potent oxidizing agents in biology, with a reduction potential of ~2.8 V and a diffusion-limited reaction rate with virtually all organic molecules. The reaction is catalytic in iron: Fe³⁺ can be reduced back to Fe²⁺ by [[Superoxide Radicals]] (the iron-catalyzed Haber-Weiss cycle), [[notes/_link/Ascorbic Acid]], or other cellular reductants, perpetuating hydroxyl radical production.

The overall Haber-Weiss reaction (superoxide-driven Fenton) is: O₂⁻• + H₂O₂ → •OH + OH⁻ + O₂, but this proceeds negligibly in the absence of iron. The true biological pathway couples spontaneous superoxide-mediated reduction of Fe³⁺ to Fe²⁺ with Fenton chemistry, yielding a catalytic iron cycle that amplifies ROS production.

## Biological Significance

The Fenton reaction is the primary mechanism by which [[notes/_link/Hydrogen Peroxide]], a relatively stable and diffusible signaling molecule, is converted into the indiscriminate and destructive [[Hydroxyl Radicals]]. This conversion is site-specific because iron is largely bound to proteins and nucleic acids — when H₂O₂ encounters iron bound to DNA, the resulting •OH inflicts damage at that precise locus, producing single-strand breaks and base modifications such as [[8-oxo-2'-deoxyguanosine]]. Similarly, iron associated with [[Cell membranes]] or proteins catalyzes local [[Lipid Peroxidation]] and protein carbonylation.
...
**Neurodegeneration:** The [[notes/_link/Substantia Nigra]] in [[notes/_link/Parkinson's Disease]] accumulates iron with age, and this iron burden correlates with oxidative damage markers. Neuromelanin, which normally chelates iron, may become saturated and release free iron, promoting localized Fenton chemistry in dopaminergic neurons.
...
## Connections
- [[notes/_link/Hydrogen Peroxide]]: The substrate that reacts with Fe²⁺.
