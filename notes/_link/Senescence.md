...
*   **Global Histone Loss**: Senescent cells experience a significant decrease in total core histones, leading to increased DNA accessibility and "leaky" transcription.
*   **[[Methylation]] Dynamics**: Global hypomethylation (particularly in repetitive elements like [[LINE-1]]) and focal hypermethylation of tumor suppressor genes.

## Roadblock to Reprogramming
Senescence is considered a major roadblock during the induction of pluripotency:
- The process of [[Cellular Reprogramming]] using [[OSKM]] factors can trigger a senescence-like response in [[Fibroblasts]].
- This is often mediated by the activation of [[notes/_link/p53]] in response to [[Innate Immunity]] signaling and [[notes/_link/Reactive Oxygen Species]] (ROS).
