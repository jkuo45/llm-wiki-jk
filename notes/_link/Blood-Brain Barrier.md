...
The blood-brain barrier (BBB) is a highly selective neurovascular interface that restricts the entry of solutes, pathogens, and immune cells from the circulation into the [[Central Nervous System]]. It is formed by cerebrovascular [[Endothelial Cells]] linked by tight junctions, supported by [[Astrocytes]] end-feet and enveloping [[Pericytes]], together comprising the neurovascular unit. By maintaining CNS homeostasis, the BBB limits [[Neuroinflammation]] and protects neurons from peripheral immune assault.
...
## Connections
  ...
  - [[Endothelial Cells]]: Vascular cells whose cGAS-STING disrupts the BBB
  - [[Pericytes]]: Perivascular cells whose cGAS destabilizes the BBB
  - [[Microglia]]: Glial cells whose STING protects the BBB
  - [[STING]]: Effector with context-dependent barrier roles
...
- New links added: [[Blood-Brain Barrier]], [[Endothelial Cells]], [[Pericytes]], [[Microglia]], [[STING]], [[cGAS]], [[Pyroptosis]], [[mtDNA]]
- Suggested new entity notes to create: [[Endothelial Cells|tight junctions]], [[Blood-Brain Barrier|neurovascular unit]], [[Blood-Brain Barrier|leukocyte infiltration]]
- Strong connections to strengthen:
    - [[Blood-Brain Barrier]] ↔ [[Microglia]]
