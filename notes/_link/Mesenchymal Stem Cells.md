...
description: Multipotent stromal cells that can donate healthy mitochondria to reverse senescence; their mesenchymal gene program is also acquired by endothelial cells undergoing EndoMT in vascular aging.
protected: false
created: 2026-07-16
updated: 2026-07-16
tags:
...
**Mesenchymal stem cells (MSCs)**, also called mesenchymal stromal cells, are multipotent adult stem cells that differentiate into osteoblasts, adipocytes, chondrocytes, and other mesenchymal lineages. They are found in bone marrow, umbilical cord, and many tissues, and are studied for their regenerative and immunomodulatory properties.
...
- MSC-derived mitochondria offer a potential senotherapeutic strategy targeting the mitochondrial basis of senescence. Age-related decline in MSC function (e.g., reduced [[NAMPT]]/[[Sirtuins|sirtuin]] activity) itself contributes to tissue senescence.

## Documents

- [[_document_ - Mitochondrial dysfunction in cellular senescence a bridge to neurodegenerative disease|Hruby & Higuchi-Sanabria 2025 — Mitochondrial Dysfunction in Senescence Bridges Neurodegeneration]]: MSC-derived mitochondrial transplantation reversed senescence markers and SASP in RS retinal pigment epithelial cells.
- [[_document_ - Senolytic Treatment With Fisetin Reverses Age‐Related Endothelial Dysfunction Partially Mediated by SASP Factor CXCL12|Mahoney et al. 2025 — Fisetin Reverses Age-Related Endothelial Dysfunction]]: Uses mesenchymal markers to quantify EndoMT in senescent endothelial cells.
...
- [[Endothelial Cells]] — Cells undergoing EndoMT toward mesenchymal state
- [[CXCL12]] — SASP factor driving EndoMT
- [[NAMPT]] — Declines in aged MSCs
- [[TNFα]] — SASP factor reduced by MSC mitochondria
- [[IL-8]] — SASP factor reduced by MSC mitochondria
