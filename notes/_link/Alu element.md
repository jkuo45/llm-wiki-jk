...
**Overview:** [[Alu element|Alu elements]] are ~300-bp short interspersed nuclear elements (SINEs) derived from the 7SL RNA gene. With ~1.1 million copies they constitute roughly 11% of the human genome, making them the most abundant [[Transposable Elements|transposable element]] family.

**Structure and Mobility:** An Alu unit is a dimer of two related monomers separated by an A-rich linker and ending in a poly(A) tail. They are transcribed by RNA polymerase III and mobilize through an RNA intermediate ("copy-and-paste") via LINE-1 (L1) ORF2 protein, though Alu itself encodes no proteins.
