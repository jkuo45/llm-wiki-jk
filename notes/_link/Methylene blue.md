...
description: Methylene blue (methylthioninium chloride) is an FDA-approved first-line
...
[[Methylene blue]] (methylthioninium chloride) is a synthetic thiazine dye and medication. It is the FDA-approved first-line treatment for symptomatic or high-level acquired [[Methemoglobinemia]], where it acts as a cofactor for [[NADPH]]–[[Methemoglobin Reductase]], reducing [[Methemoglobin]] (Fe3+) back to functional [[Hemoglobin]] (Fe2+). At low doses it also functions as a mitochondrial redox cycler and monoamine oxidase inhibitor.

## Clinical Indications

- **Methemoglobinemia (FDA-approved):** IV 1 mg/kg over 5–30 min; repeat once after 1 h if MetHb remains >30%. Single dose only in renal impairment (eGFR 15–59).
...
Methylene blue is reduced by [[NADPH]]-dependent [[Methemoglobin Reductase]] to leucomethylene blue, which nonenzymatically reduces ferric heme back to ferrous hemoglobin.

### Mitochondrial electron shuttling
Methylene blue bypasses dysfunctional [[Complex I]]/[[Complex III]] of the [[Mitochondrial Electron Transport Chain]], shuttling electrons from [[NADH]] directly to [[Cytochrome c]]. This sustains [[ATP]] production, lowers [[Mitochondrial Superoxide]], and reduces [[Oxidative Stress]] — the basis of its [[Hormetic Window|hormetic]] neuroprotective and mitochondrial effects.

### Nitric oxide pathway
Methylene blue inhibits [[Nitric Oxide Synthase]] and [[Soluble Guanylyl Cyclase]] (downstream of [[Nitric Oxide]]), blocking the NO→[[Cyclic Guanosine Monophosphate]] vasodilation cascade. This underlies its utility in [[Vasoplegic Shock]].

### Monoamine oxidase inhibition
Methylene blue is a potent [[Monoamine Oxidase Inhibitor]] (MAO-A), raising synaptic [[Serotonin]], [[Dopamine]], and [[Norepinephrine]] — the basis of its mood effects and its dangerous [[Serotonin Syndrome]] interaction with serotonergic drugs.
...
- **Pregnancy:** fetal harm risk (intra-amniotic → [[Intestinal Atresia]], fetal demise; neonatal [[Hyperbilirubinemia]], methemoglobinemia).
- **Purity:** only USP/pharmaceutical-grade; industrial dye contains heavy metals.
...
- [[Methemoglobin]] — reduced to ferrous state
- [[Hemoglobin]] — restored function
- [[NADPH]] / [[Methemoglobin Reductase]] — reduce MB to leucomethylene blue
- [[Vitamin C]] — alternative reducing agent when MB contraindicated
- [[Mitochondrial Electron Transport Chain]] — bypassed at Complex I/III
- [[NADH]] / [[Cytochrome c]] — electron shuttle endpoints
- [[Nitric Oxide Synthase]] / [[Soluble Guanylyl Cyclase]] — inhibited (vasoconstriction)
- [[Nitric Oxide]] / [[Cyclic Guanosine Monophosphate]] — downstream signaling blocked
- [[Monoamine Oxidase Inhibitor]] — MAO-A activity (mood, serotonin syndrome)
