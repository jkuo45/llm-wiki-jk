...
Microglia originate from yolk-sac progenitors during early embryogenesis and are maintained throughout life by local self-renewal, independent of circulating monocytes.
...
## cGAS-STING Signaling in Microglia
...
## Documents
  ...
  - [[_document_ - JCI -Expanding roles of cGAS-STING signaling in neuroinflammation|JCI cGAS-STING in Neuroinflammation]]
    - Establishes microglia as the dominant source of cGAS in the diseased brain and details how microglial cGAS-STING/IFN-I signaling drives neurotoxic gliosis, tau propagation, and cognitive decline, while its inhibition preserves phagocytic clearance.

## Connections
- [[Parkinson's Disease]] — neurodegenerative disease; α-synuclein pathology; dopamine loss
- [[Neuromelanin]] — interacts with Microglia
- [[Microgliosis]] — interacts with Microglia
- [[Neuronophagia]] — interacts with Microglia
- [[Cytokines]] — interacts with Microglia
- [[Reactive Oxygen Species]] — interacts with Microglia
- [[Neuroinflammation]] — interacts with Microglia
- [[Substantia Nigra]] — interacts with Microglia
- [[cGAS]] — microglia are the dominant CNS source; cGAS drives their inflammatory activation
- [[cGAS-STING Pathway]] — microglial cGAS-STING is the major upstream regulator of IFN-I neurodegeneration
- [[Type I Interferon]] — microglial IFN-I output propagates neurotoxicity to neurons
- [[Disease-Associated Microglia]] — cGAS-driven IFN-I microglial state is distinct from DAM
