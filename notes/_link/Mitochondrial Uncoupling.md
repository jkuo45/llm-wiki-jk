...
[[Mitochondrial Uncoupling]] is the process by which the proton motive force across the inner mitochondrial membrane is dissipated without ATP synthesis, typically via proton leak back into the matrix. The energy is released as heat rather than captured in ATP.

## Biological Role / Mechanism

Uncoupling is mediated by:

- **Uncoupling proteins (UCPs)** — e.g., UCP1 in brown adipose tissue drives thermogenesis; UCP2/UCP3 modulate redox and fatty acid handling.
- **Chemical uncouplers** — protonophores such as [[FCCP]] and [[2,4-Dinitrophenol]] collapse the gradient.
- **Proton leak** — basal inner-membrane conductance.

Uncoupling lowers the proton gradient, accelerating [[Electron Transport Chain]] flux and increasing oxygen consumption while reducing ROS production at high membrane potential. It intersects with [[Nicotinamide nucleotide transhydrogenase]] and redox homeostasis.
...
- [[Mitochondria]]: Uncoupling occurs at the inner mitochondrial membrane.
