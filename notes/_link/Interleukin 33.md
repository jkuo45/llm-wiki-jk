...
tags:
  ...
  - senescence
  - inflammation
aliases: [IL-33, Interleukin-33, DVS27, NF-HEV]
---

# Interleukin 33 (IL-33)

**Interleukin-33 (IL-33)** is a member of the [[Interleukin 1β|IL-1]] cytokine family and functions as a nuclear alarmin. In the senescence context it is an [[Interleukin 1β|IL-1β]]-dependent SASP interleukin whose release from senescent hepatic stellate cells promotes [[Hepatocellular Carcinoma]] development.
...
- IL-33 is a pro-tumorigenic SASP factor secreted by senescent stromal (hepatic stellate) cells.
- It links stress-induced [[Senescence]] in the stroma to epithelial [[Cancer]] initiation and progression in the liver.
- The IL-1β dependence means IL-33 amplifies the upstream SASP-initiator loop rather than acting alone.

## Clinical / Pathological Relevance
- IL-33/ST2 blockade is explored in asthma, allergy, and fibrosis.
- Targeting IL-33 may interrupt senescence-driven liver tumorigenesis.
- IL-33 is elevated in varied inflammatory and fibrotic conditions and serves as a damage-associated biomarker.
