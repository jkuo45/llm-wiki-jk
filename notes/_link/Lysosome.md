...
List of documents that mention this entity
  ...
  - [[_document_ - Autophagy and intermittent fasting the connection for cancer therapy?|Autophagy and intermittent fasting the connection for cancer therapy?]]
    - Autophagy is an evolutionarily conserved Lysosome catabolic process by which cells degrade and recycle intracellular endogenous (damaged organelles, misfolded or mutant proteins and macromolecules) and exogenous (viruses and bacteria) components to maintain...

  - [[_document_ - Autophagy takes it all – autophagy inducers target immune aging|Autophagy takes it all – autophagy inducers target immune aging]]
    - In summary, cytoplasmic material is entrapped in double-membrane Autophagosome that then fuse with Lysosome in which their content is degraded and recycled.
  ...
  - [[_document_ - TFEB AND TFE3, LINKING LYSOSOMES TO CELLULAR ADAPTATION TO STRESS|TFEB AND TFE3, LINKING LYSOSOMES TO CELLULAR ADAPTATION TO STRESS]]
    - Rosa Puertollano 2, PMCID: NIHMSID: NIHMS821698 Abstract In recent years, our vision of Lysosome has drastically changed. From being considered as mere degradative compartments, they are now recognized as key players in many cellular processes.

  - [[_document_ - The Beneficial and Adverse Effects of Autophagic Response to Caloric Restriction and Fasting|The Beneficial and Adverse Effects of Autophagic Response to Caloric Restriction and Fasting]]
    - PMCID: Abstract Each cell is equipped with a conserved housekeeping mechanism, known as Autophagy, to recycle exhausted materials and dispose of injured organelles via Lysosome.

  - [[_document_ - mTOR signaling at a glance|mTOR signaling at a glance]]
    - Autophagy Autophagy – that is, the sequestration of intra - cellular components within Autophagosome and their degradation by Lysosome – is a catabolic process that is important in organelle degradation and protein turnover.

  - [[_document_ - Cellular Mechanisms and Regulation of Quiescence|Cellular Mechanisms and Regulation of Quiescence]]
    - Conversely, many quiescent cell types have larger and more abundant Lysosome than their proliferative counterparts, and upregulate many lysosome-associated genes (Fujimaki et al., 2019; Kobayashi et al., 2019; Leeman et al., 2018; Liang et al., 2020; Min an...
...
- [[V-ATPase]] — catalyzes reaction involving Lysosome
- [[Autophagic Lysosome Reformation]] — interacts with Lysosome
