...
[[SIRT2]] deacetylates HNF4α at multiple lysine residues in its hinge and ligand-binding domains, enhancing its protein stability and transcriptional output. In the liver, SIRT2-mediated deacetylation of HNF4α promotes the expression of genes controlling fatty acid β-oxidation and prevents [[Hepatic Steatosis|liver steatosis]]. Loss of SIRT2 or hyperacetylation of HNF4α leads to lipid droplet accumulation, impaired mitochondrial function, and a metabolic shift toward [[Lipotoxicity|lipotoxicity]]. This mechanism positions SIRT2 as a safeguard against [[Non-alcoholic Fatty Liver Disease]] (NAFLD) and related metabolic disorders.
...
- [[SIRT2]] — Deacetylates and stabilizes HNF4α, preventing hepatic steatosis
- [[Hepatic Steatosis]] — Pathological lipid accumulation in hepatocytes; suppressed by SIRT2–HNF4α axis
- [[Non-alcoholic Fatty Liver Disease]] — Clinical spectrum linked to HNF4α dysregulation
- [[PGC-1α]] — Coactivator that partners with HNF4α in gluconeogenesis and mitochondrial biogenesis
- [[NAD+]] — Substrate for SIRT2-dependent deacetylation of HNF4α
