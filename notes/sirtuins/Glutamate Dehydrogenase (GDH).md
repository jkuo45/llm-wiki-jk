...
**Glutamate Dehydrogenase (GDH)** is a mitochondrial enzyme that plays a critical role in amino acid metabolism, cellular energy homeostasis, and insulin secretion. It catalyzes the reversible oxidative deamination of L-glutamate to $\alpha$-ketoglutarate, providing carbon intermediates for the tricarboxylic acid (TCA) cycle and ATP production.

## Structure & Mechanism

GDH is a hexameric allosteric enzyme localized to the mitochondrial matrix. It uses NAD+ or NADP+ as cofactor and is exquisitely regulated by small molecules: ATP and GTP inhibit it, whereas ADP and leucine (a branched-chain amino acid) activate it, allowing the enzyme to sense the cellular energy charge and amino acid supply. Its reaction — glutamate + NAD(P)+ + H2O ⇌ $\alpha$-ketoglutarate + NH4+ + NAD(P)H — is freely reversible, enabling either oxidative deamination (catabolism) or reductive amination (glutamate synthesis).

## Physiological Role

GDH couples amino acid catabolism to energy production. In liver and kidney it funnels carbon from glutamate into the TCA cycle; in brain it buffers neurotransmitter glutamate and guards against [[Excitotoxicity]]. In pancreatic β-cells, GDH provides an amino-acid-sensing branch of insulin secretion independent of glucose.
...
In mouse models, deletion of the *Sirt4* gene leads to hyper-activation of GDH in pancreatic islets, abnormally elevated insulin levels, and upregulation of amino-acid-stimulated insulin secretion (particularly in response to glutamine). These mice are protected from diet-induced obesity, linking the SIRT4–GDH axis to systemic energy balance.
