...
In mouse models, deletion of the *Sirt4* gene leads to:
- Hyper-activation of GDH in pancreatic islets.
- Abnormally elevated insulin levels.
- Upregulation of amino-acid-stimulated insulin secretion (particularly in response to glutamine).

## Neurological Relevance

Given that glutamate is the primary excitatory neurotransmitter in the central nervous system, GDH is also crucial in the brain. It regulates synaptic glutamate levels, preventing excitotoxicity. The regulation of GDH by mitochondrial sirtuins like SIRT4 could play a role in modulating synaptic transmission or neuroprotection after ischemic injury.
