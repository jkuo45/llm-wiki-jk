...
- **Localization**: Localizes to the lysosomal compartment (co-localizes with the marker [[PGP-2]]).
- **Enzymatic Activity**: Exhibits acid lipase activity, specifically at pH 4.5, characteristic of the lysosomal lumen.
- **Transcriptional Control**:
    - Repressed by [[MXL-3]] when nutrients are available.
