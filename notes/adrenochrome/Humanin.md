...
Humanin was originally identified as a cytoprotective factor for [[Alzheimer's Disease]]. It circulates in plasma and has broad cytoprotective, anti-apoptotic, and metabolic regulatory effects. It is involved in [[Mitohormesis]] by providing systemic protection against various stresses.

## Mitochondrial-Derived Peptide Family

Humanin is the prototypical [[Mitochondrial-Derived Peptide]] (MDP), a family of short bioactive peptides encoded within the mitochondrial genome that are transcribed and translated independently of the canonical 13 mitochondrial-encoded proteins. The humanin gene resides in the [[16S Ribosomal RNA]] (MT-RNR2) gene, and its open reading frame (ORF) is conserved across mammals but is absent in lower eukaryotes. Alternative translation initiation sites generate several humanin isoforms, including the full-length 24-amino acid form (HN1) and a C-terminally truncated 21-amino acid form (HNG), the latter exhibiting enhanced stability and potency. A larger family of related MDPs includes [[MOTS-c]] (encoded in [[12S Ribosomal RNA]]), [[SHLPs]] (Small Humanin-Like Peptides), and [[Humanin-Like Peptides]] (encoded in nuclear pseudogenes of MT-RNR2). These peptides collectively constitute a mitochondrial stress response signaling network, relaying information about mitochondrial functional status to the nucleus and to distant tissues — a process termed the [[Mitokine Response]].

## Cytoprotective Mechanisms

Humanin exerts its broad cytoprotection through multiple convergent signaling pathways. The primary receptor for humanin is a cell-surface complex consisting of [[Ciliary Neurotrophic Factor Receptor]] (CNTFR), [[WSX1]] (IL-27Rα), and [[gp130]] (IL-6Rβ). Ligand binding triggers [[Janus Kinase 2]] (JAK2) phosphorylation, which activates three downstream axes:

1. **[[STAT3]] Activation**: Phosphorylated STAT3 dimerizes and translocates to the nucleus, where it transactivates anti-apoptotic genes including [[BCL-2]], [[BCL-XL]], and [[Survivin]] ([[BIRC5]]), while suppressing [[Bax]] and [[Bim]] expression. STAT3 also translocates to mitochondria directly, where it maintains [[Mitochondrial Membrane Potential]] and reduces [[Cytochrome c]] release during stress.
...
Humanin levels decline with age in multiple mammalian species. In human plasma, circulating humanin decreases approximately 50% between age 20 and 80, and this decline correlates with increased [[Insulin Resistance]], [[Cognitive Decline]], and [[Frailty Index]] in cohort studies. Transgenic mice overexpressing humanin show a 15–20% increase in median lifespan, reduced incidence of age-related [[Hepatocellular Carcinoma]] and [[Lymphoma]], and preservation of [[Skeletal Muscle]] mass and [[Cognitive Function]] during aging. Humanin transgenic mice also exhibit improved [[Glucose Tolerance]], reduced [[Adiposity]], and lower [[TNF-α]] levels. In [[C. elegans]], expression of the humanin ortholog [[CEL-1]] extends lifespan through a [[Daf-16]]/[[FOXO]]-dependent pathway. Inverted correlation between humanin levels and [[Alzheimer's Disease]] severity has been observed in cerebrospinal fluid, suggesting a protective role in neurodegeneration.

## Connection to Mitohormetic Signaling

Humanin functions as both a downstream effector and an upstream regulator of mitohormetic signaling. As a [[Mitokine]], its expression is induced by mild mitochondrial stress — including [[Mitochondrial Unfolded Protein Response]] (UPR^mt), [[Mitophagy]], and Complex I inhibition — providing a molecular link between mitochondrial health and systemic stress resistance. Humanin expression is upregulated by [[NAD⁺]]-dependent [[SIRT1]] activation and by [[AMPK]], and is suppressed by [[mTORC1]], positioning humanin within the nutrient-sensing network that governs longevity. In the context of the [[Mitohormetic Redox-Relay]] strategy, humanin represents a candidate mediator of the systemic benefits observed: local mitochondrial stress in one tissue (induced by ultralow-dose [[Adrenochrome]] or [[Carbazochrome]]) may trigger humanin secretion, conferring cytoprotection to distal tissues. This concept — "mitochondrial stress begets systemic protection" — suggests that strategies combining mitohormetic triggers with humanin-enhancing interventions could amplify adaptive responses.
