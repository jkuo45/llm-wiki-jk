...
## Oxidative Polymerization Mechanisms

Catecholamine polymerization proceeds through oxidative coupling of reactive intermediates. Following the initial two-electron oxidation of a catecholamine to its [[o-quinone]] and subsequent cyclization to the [[Aminochrome]], the indole ring undergoes further oxidation to the corresponding [[Indole-5,6-quinone]]. These quinoid species are highly electrophilic and participate in intermolecular cross-coupling reactions. The polymerization involves repeated cycles of: (1) one-electron oxidation of the hydroquinone form to a [[Semiquinone radical]]; (2) radical–radical coupling (C–C and C–O bond formation between indole units); and (3) re-aromatization to extend the conjugated π-system. The resulting insoluble polymer — a heterogeneous mixture of dihydroxyindole, indolequinone, and partially cyclized units — constitutes the melanin pigment.

## Role of Semiquinone Radical Intermediates

The [[Semiquinone radical]] is the critical chain-propagating species in oxidative polymerization. Formed by either one-electron oxidation of the hydroquinone or one-electron reduction of the quinone, the semiquinone exists in equilibrium with its parent redox forms (the [[Comp proportionation]] equilibrium). The semiquinone's unpaired electron is delocalized across the indole ring, rendering it stable enough to diffuse and encounter another radical for coupling. [[Electron paramagnetic resonance]] (EPR) studies confirm persistent semiquinone signals during adrenochrome polymerization, with g-values ~2.004 characteristic of carbon-centered organic radicals. The coupling regiochemistry is influenced by steric and electronic factors: C3–C3′ and C3–O4′ linkages predominate in the early polymer, while later stages involve more random crosslinking.
