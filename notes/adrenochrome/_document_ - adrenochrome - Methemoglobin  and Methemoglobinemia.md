...
tags:
  - clippings
---
research [[Methemoglobin]]

[[Methemoglobin]] (MetHb) is a form of [[hemoglobin]] in which the iron in the heme group is oxidized from the ferrous (Fe²⁺) state to the ferric (Fe³⁺) state. Unlike normal [[hemoglobin]], it cannot effectively bind or transport oxygen. It appears bluish chocolate-brown in color. In healthy individuals, a small amount (typically <1–2% of total [[hemoglobin]]) forms spontaneously but is rapidly reduced back to functional [[hemoglobin]] by enzymes, primarily [[NADH-dependent methemoglobin reductase]] (also called [[cytochrome b5 reductase]] or [[diaphorase]]).
...
- Normal: 1–2% or less.
	[en.wikipedia.org](https://en.wikipedia.org/wiki/Methemoglobin)
- <10%: Usually asymptomatic.
- 10–20%: [[Cyanosis]] (bluish/gray skin, lips, mucous membranes, nail beds); "chocolate brown" blood.
- 20–30%: Headache, anxiety, dyspnea on exertion, fatigue.
- 30–50%: Dizziness, confusion, tachycardia, tachypnea.
- 50–70%: Coma, seizures, arrhythmias, acidosis.
- \>70%: Life-threatening, high risk of death.
	[en.wikipedia.org](https://en.wikipedia.org/wiki/Methemoglobin)
[[Pulse oximetry]] often reads inaccurately (typically around 85%), and [[arterial blood gas]] may show normal PaO₂ but clinical [[cyanosis]] unresponsive to supplemental oxygen. [[Co-oximetry]] is the gold standard for diagnosis.

[ncbi.nlm.nih.gov](https://www.ncbi.nlm.nih.gov/books/NBK537317/)

Types and Causes

1\. Congenital (Hereditary) [[Methemoglobinemia]] (Rare)

- Enzyme deficiency (most common congenital form): Autosomal recessive mutations in [[cytochrome b5 reductase]] (CYB5R). Type 1 ([[erythrocyte]] only) mainly causes [[cyanosis]]; Type 2 (systemic) is more severe with neurological issues.
	[ncbi.nlm.nih.gov](https://www.ncbi.nlm.nih.gov/books/NBK537317/)
- [[Hemoglobin M]] (HbM) disease: Autosomal dominant mutations in globin genes (α, β, or γ chains) that stabilize the Fe³⁺ state. Patients often have lifelong [[cyanosis]] but are otherwise asymptomatic or mildly affected.
Congenital forms are present from birth (or appear in infancy) and are rarer than acquired forms.
...
- Clinical: [[Cyanosis]] not improving with oxygen, chocolate-brown blood.
- Lab: [[Co-oximetry]] measuring MetHb percentage; standard [[ABG]] and [[pulse oximetry]] have limitations.
...
- Mild cases (especially congenital) may only involve cosmetic [[cyanosis]].
- Severe acquired cases can be rapidly fatal without intervention but are treatable.
- Recent trends note increases in nitrite-related cases from recreational use or intentional ingestion.
	[sciencedirect.com](https://www.sciencedirect.com/science/article/pii/S2214750024000283)
