...
Protein kinase C zeta (PKCζ) is an atypical member of the [[Protein Kinase C]] family that, unlike classical and novel isoforms, is independent of both calcium and diacylglycerol. Instead, PKCζ is activated downstream of phospholipase D and phosphatidic acid and by the small GTPase Rac1/Cdc42 through the Par6 polarity complex. PKCζ is a key survival and polarity kinase, frequently overexpressed or hyperactivated in human [[Cancer]].

## Structure & Mechanism

PKCζ contains an N-terminal regulatory region with a Phox/Bem1 (PB1) domain (mediating interactions with Par6 and p62/[[SQSTM1]]), a C1 domain lacking DAG-binding cysteines, and a C-terminal catalytic domain. It phosphorylates substrates including the NF-κB-activating kinase TAK1/TAB complex and directly phosphorylates pro-apoptotic proteins. Notably, PKCζ phosphorylates and inhibits [[Caspase-9]] and [[Bax]], suppressing their pro-apoptotic functions and thereby promoting cell survival.
...
- [[Caspase-9]] - Apoptotic initiator caspase inhibited by PKCζ phosphorylation.
- [[Bax]] - Pro-apoptotic Bcl-2 family protein inhibited by PKCζ.
- [[Protein Kinase C]] - Enzyme family to which PKCζ belongs.
- [[NF-κB]] - Survival transcription factor activated downstream of PKCζ.
- [[PI3K]] - Upstream pathway that cooperates with PKCζ survival signaling.
- [[Cancer]] - Disease where PKCζ is commonly hyperactivated.
- [[Chemotherapy]] - PKCζ inhibition restores apoptotic sensitivity.
