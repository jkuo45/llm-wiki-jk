...
description: 'Membrane blebbing is a characteristic morphological feature observed
...
## Mechanism
The process is driven by the activation of executioner caspases, such as [[Caspase-3]], which cleave proteins that regulate the cytoskeleton (e.g., [[ROCK1]]). This leads to increased actomyosin contractility, which forces the membrane outward.
