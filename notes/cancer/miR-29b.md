...
**miR-29b** is a member of the miR-29 family of microRNAs (miR-29a/b/c) that functions as a context-dependent regulator of cell survival, differentiation, and tissue architecture. Encoded by the *MIR29B1* and *MIR29B2* loci, miR-29b is highly expressed in terminally differentiated tissues and is frequently downregulated in human cancers, where its loss contributes to the [[Hallmarks of Cancer]] including evasion of [[Apoptosis]], enhanced proliferation, and pathological remodeling of the extracellular matrix.

## Overview and Structure

Mature miR-29b is an ~22-nucleotide non-coding RNA that guides the RNA-induced silencing complex (RISC) to complementary sequences in the 3′ untranslated regions of target mRNAs, typically repressing translation or promoting deadenylation and decay. The miR-29 family is evolutionarily conserved and has emerged as one of the most broadly tumor-suppressive miRNA clusters identified to date.
...
miR-29b is a candidate therapeutic and prognostic biomarker. Delivery of miR-29 mimics, and small molecules that de-repress the *MIR29* loci, are under investigation. Its dual role in apoptosis and ECM regulation makes it a compelling node for combination strategies targeting both cell death and the tumor stroma.
