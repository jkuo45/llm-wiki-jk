...
description: Therapy-induced senescence (TIS) is a state of permanent cell cycle arrest triggered in tumor cells by chemotherapeutic drugs or ionizing radiation, with dual roles in tumor suppression and relapse via the SASP.
created: 2026-07-09
updated: 2026-07-09
tags:
  - biological-process
  ...
  - cancer
  - chemotherapy
aliases: [TIS, therapy-induced senescence, treatment-induced senescence]
---

# Therapy-Induced Senescence

**Therapy-induced senescence (TIS)** is a state of essentially irreversible [[Cell Cycle]] arrest provoked in tumor cells by genotoxic cancer therapies, including [[Chemotherapy|chemotherapeutic drugs]] (e.g., doxorubicin, etoposide, cisplatin) and [[Ionizing Radiation]]. First characterized as an unintended side effect, TIS is now recognized as a deliberate therapeutic outcome — a built-in tumor-suppressive program that prevents proliferation of damaged malignant cells (Ewald et al., 2010, *J Natl Cancer Inst* 102:1536-1546; PMID 20858887).

## Triggers

TIS can be induced by a broad range of anticancer agents:

- **DNA-damaging chemotherapeutics**: Doxorubicin, [[Etoposide]], [[Cisplatin]], cyclophosphamide — agents that create [[DNA Damage]] lesions triggering a persistent [[DNA Damage Response]].
- **Ionizing radiation**: Causes double-strand breaks that engage the ATM/ATR–Chk1/Chk2–p53 axis.
- **CDK4/6 inhibitors**: [[Palbociclib]], [[abemaciclib]], [[ribociclib]] induce senescence-like arrest in [[Breast Cancer|estrogen receptor-positive breast cancer]] cells by mimicking the [[p16 INK4a|p16]]–[[Retinoblastoma Protein|Rb]] pathway without triggering a full DDR.
...
- **Senomorphics**: Agents that suppress the SASP without killing cells (e.g., [[Rapamycin]], glucocorticoids, [[Metformin]]) may limit TIS-driven inflammation while preserving arrest.
...
- [[p16 INK4a|p16]] — Locks in sustained TIS arrest
...
- [[Cytoplasmic Chromatin Fragments]] — Accumulate in TIS cells activating cGAS-STING
