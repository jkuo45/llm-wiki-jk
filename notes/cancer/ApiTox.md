...
aliases: [Bee Venom Extract, Apitoxin]
url: #
source: #
---
...
- [[Melittin]] induces [[Apoptosis]] in [[melanoma]], [[Breast Cancer]], [[Hepatocellular Carcinoma]], and [[lung cancer]] cells.
- Synergizes with conventional [[chemotherapy]] agents.
- Nanoparticle formulations of melittin are being developed to reduce hemolytic toxicity.

## Anti-Inflammatory Activity

- Bee venom therapy has been used in traditional medicine for [[rheumatoid arthritis]] and chronic [[Inflammation]].
- [[Phospholipase A2]] in low doses can exert anti-inflammatory effects via regulatory T cell induction.

---

## Documents

This entity is not linked to the current senescence/SASP document. It is relevant to the existing apitherapy and melittin content in this directory.
...
- New links added: [[apamin]], [[mast cell degranulating peptide]], [[adolapin]]
- Suggested new entity notes to create: --none--
- Strong connections to strengthen: [[ApiTox]] ↔ [[melittin]] (principal component)
