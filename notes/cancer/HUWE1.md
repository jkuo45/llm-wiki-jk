...
HECT, UBA and WWE domain-containing protein 1 (HUWE1), also known as MULE (Mcl-1 ubiquitin ligase E3), ARF-BP1 (ARF-binding protein 1), and LASU1 (large subunit 1), is a ~482 kDa E3 ubiquitin ligase and the largest member of the HECT (homologous to E6-AP carboxyl terminus) family of E3 ligases. It is encoded by the *HUWE1* gene and plays pleiotropic roles in regulating [[Apoptosis]], [[Ubiquitination]], the [[p53]] pathway, [[c-Myc]] stability, and genomic integrity.

## Structure & Domains

HUWE1 contains a C-terminal HECT catalytic domain responsible for ubiquitin transfer to substrate proteins. Its multi-domain architecture includes an N-terminal ubiquitin-associated (UBA) domain, a WWE domain (named for conserved W and E residues) implicated in poly-ADP-ribose binding and protein–protein interactions, and a BH3 ([[BH3 domain|Bcl-2 homology 3]]) domain that mediates binding to pro-survival Bcl-2 family members such as [[Mcl-1]]. The large size (~482 kDa) and domain complexity enable HUWE1 to engage diverse substrates through multiple interaction interfaces.

## Mechanism of Action & Pathways

HUWE1 functions as a HECT E3 ubiquitin ligase, catalyzing the transfer of ubiquitin from an E2 enzyme to specific lysine residues on target proteins. Its best-characterized substrate is the pro-survival protein [[Mcl-1]]: HUWE1 ubiquitinates Mcl-1, marking it for proteasomal degradation, thereby promoting [[Apoptosis]]. Beyond Mcl-1, HUWE1 targets a broad range of substrates critical for cell survival, proliferation, and genome stability:

- **[[p53]]** — HUWE1 (as ARF-BP1) directly ubiquitinates p53, promoting its degradation. The tumor suppressor ARF (p14^ARF^) binds HUWE1 and inhibits its ability to ubiquitinate p53, thereby stabilizing p53.
- **[[BRCA1]]** — HUWE1 ubiquitinates BRCA1, influencing DNA repair signaling and homologous recombination.
...
The role of HUWE1 in cancer is highly context-dependent, reflecting its broad substrate repertoire.

- **Tumor-suppressive functions**: [[Lung Cancer|Lung cancer]] models with HUWE1 deletion show marked stabilization of [[Mcl-1]], leading to apoptosis resistance and poor therapeutic response. Loss of HUWE1 also promotes genomic instability through dysregulated [[BRCA1]] turnover and impaired DNA repair.
...
- [[USP9X]] — Deubiquitinase that counteracts HUWE1-mediated Mcl-1 degradation
- [[Apoptosis]] — HUWE1 promotes apoptosis through Mcl-1 degradation
- [[Ubiquitination]] — HUWE1 is a HECT family E3 ubiquitin ligase
- [[p53]] — HUWE1 (ARF-BP1) ubiquitinates p53; inhibited by ARF
- [[c-Myc]] — HUWE1 targets c-Myc for degradation; overexpression in ovarian cancer promotes Myc-driven tumorigenesis
- [[ARF]] — Binds HUWE1 and inhibits p53 ubiquitination, stabilizing p53
