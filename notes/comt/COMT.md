...
COMT exists in two distinct forms encoded by the same gene:
- **Soluble COMT (S-COMT):** The predominant form in peripheral tissues (liver, kidney, blood). Contains 221 amino acids.
- **Membrane-bound COMT (MB-COMT):** The predominant form in the brain. Contains 271 amino acids with an additional N-terminal transmembrane domain. MB-COMT has a higher affinity (lower K~m~) for catecholamine substrates than S-COMT, making it more relevant for neurotransmitter metabolism at physiological concentrations.

## Genetics

The [[COMT]] gene is located on chromosome 22q11.21 and is well-known for the [[Val158Met]] [[SNP]] (rs4680), which significantly impacts enzyme activity:

- **Fast COMT (Val/Val, G/G):** High enzyme activity (3–4× faster than Met/Met), leading to lower levels of synaptic dopamine. Often called the "warrior" type, associated with better stress resilience but potentially poorer cognitive performance on complex tasks.
- **Intermediate COMT (Val/Met, A/G):** Balanced enzyme activity with one high-activity and one low-activity allele.
- **Slow COMT (Met/Met, A/A):** Low enzyme activity (3–4× reduced), leading to higher baseline synaptic dopamine. Often called the "worrier" type, associated with higher anxiety and stress sensitivity but potentially superior performance on cognitive tasks requiring sustained attention.

Population frequencies vary: the Met/Met (slow) genotype occurs in approximately 20–30% of European-ancestry individuals, while the Val/Val (fast) genotype is found in about 29% of Caucasians and 52% of Chinese Han populations.
