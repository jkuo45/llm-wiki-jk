...
**[[Plan-Execute Agentic Design Pattern|Plan-Execute Pattern]]:**
The [[Plan-Execute Agentic Design Pattern|Plan-Execute pattern]] consists of two main phases:
1. **[[Planning]]**: In this phase, an agent considers its current state, [[Goal|goals]], and [[Environment|environment]] to determine a [[Plan Generation|plan]] of action. The plan is a set of instructions that, when [[Execution|executed]], will help the agent achieve its goals.
...
2. The agent generates a plan of action to achieve its goals. This involves [[Reasoning|reasoning]] about possible courses of action, their expected outcomes, and potential consequences.
...
6. If necessary, the agent may [[Replanning|replan]] and re-execute based on new information or changes in the environment.

**Key benefits:**
The [[Plan-Execute Agentic Design Pattern|Plan-Execute pattern]] offers several advantages in agent-based systems:
...
**Examples:**
1. In a [[Distributed Manufacturing|distributed manufacturing system]], a robot might plan its assembly steps based on incoming orders and then execute those plans to produce the desired products.
2. A [[Self-Driving Cars|self-driving car]] might plan its route based on traffic conditions and then execute that plan by following the designated path.
3. In a [[Social Networks|social network]], an agent (e.g., a user) might plan its communication strategy based on its goals (e.g., building relationships) and then execute that plan by sending messages or engaging in conversations.
...
3. **[[Multi-Agent Planning]]**: In [[Multi-Agent Systems (MAS)|multi-agent systems]], agents may need to coordinate their plans with other agents to achieve common goals.

By incorporating the [[Plan-Execute Agentic Design Pattern]] into your agent-based system, you can create more flexible, efficient, and autonomous decision-making processes that are better equipped to handle the complexities of dynamic environments.

---

[[PHI-3]]

The [[Agentic Design Patterns|agent-oriented design pattern]] (also known as the Plan and Execute pattern) is commonly used in [[Autonomy|autonomous]] or semi-autonomous agents within an [[Agent-Based Systems (ABS)|Agent-Based System (ABS)]]. The goal of this design pattern is to allow a system's agents to make decisions, plan actions based on those decisions, execute their plans effectively, and adapt when necessary. Here's how it works:
...
This Plan and Execute design pattern is widely employed in various domains of AI, including autonomous [[Robotics|robotics]], [[Multi-Agent Systems (MAS)]], intelligent software applications, [[Supply Chain Management]], distributed computing, etc., enabling agents to handle complex tasks efficiently while adapting to changing environments.

---

The [[Agentic Design Patterns|Agent-Based Design Pattern]], also known as the [[Plan-Execute Agentic Design Pattern|Plan-Execute Design Pattern]], is a conceptual framework often used in [[Agent-Based Systems (ABS)|agent-based systems]] to organize the behavior of software agents in an [[Efficiency|efficient]] manner. This pattern divides an agent's actions into two main phases: planning and execution. Here's how it works, along with steps on implementing such a design pattern within an [[Agentic Systems|agentic system]].
...
### Connections
- Core concept in [[AI Agents and Multi-Agent Systems (MAS)]].
- See [[Prompt Exa - Contents]] for literature on planning in LLM agents.

### Linking Summary
- New links added: [[Goal]], [[Environment]], [[Reasoning]], [[Replanning]], [[Efficiency]], [[Autonomy]], [[Distributed Manufacturing]], [[Self-Driving Cars]], [[Social Networks]], [[Hierarchical Planning]], [[Multi-Agent Planning]], [[Multi-Agent Systems (MAS)]], [[PHI-3]], [[Agentic Design Patterns]], [[Agent-Based Systems (ABS)]], [[Perception]], [[Goal Formulation]], [[Plan Generation]], [[Plan Selection]], [[A* Search]], [[Monte Carlo Tree Search (MCTS)]], [[Markov Decision Processes (MDPs)]], [[Action Execution]], [[State Monitoring]], [[Goal Check]], [[Failure Handling and Recovery]], [[Robotics]], [[Supply Chain Management]], [[Modularity]], [[Maintainability]], [[Agentic Systems]], [[Scalability]].
- Suggested new entity notes to create: [[Plan Generation]], [[Goal Formulation]], [[Action Execution]], [[State Monitoring]], [[Goal Check]], [[Agentic Systems]].
- Strong connections to strengthen: [[Plan-Execute Agentic Design Pattern]] ↔ [[AI Agents and Multi-Agent Systems (MAS)]].
