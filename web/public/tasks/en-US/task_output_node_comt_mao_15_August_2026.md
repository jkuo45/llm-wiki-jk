...
> Method: `uv run --with networkx --with scipy python3 scripts/analysis/node_analysis.py --sources comt mao --targets dopamine epinephrine`
...
- Numbers reproduce with `scripts/analysis/node_analysis.py`; default seed 1.
