...
const VLT = {
  ...
  'Ribosome Biogenesis': 'Ribosome Biogenesis', 'LINE-1': 'LINE-1',
  Opicapone: 'Opicapone', NLRP3: 'NLRP3',
  'Caspase-1': 'Caspase-1', GSDMD: 'GSDMD',
  'Adrenaline-quinone': 'Adrenaline-quinone', Myeloperoxidase: 'Myeloperoxidase',
  'Redox cycle': 'Redox cycle', Polymerization: 'Polymerization', Melanins: 'Melanins',
  Magnesium: 'Magnesium', EMT6: 'EMT6', 'Lipid Peroxidation': 'Lipid Peroxidation',
};
...
export const STR = {
  en: {
    ...
    adrenoSteps: [
      { t: 'Adrenaline on the edge', b: 'Epinephrine (adrenaline) pools in cytosol and extracellular fluid. Trace metals, superoxide and myeloperoxidase-derived oxidants strip one electron: the semiquinone radical, then adrenaline-quinone. Green particles stream inward from outside the cell.', legend: [['#51ff9e', 'epinephrine inflow']], vault: ['Adrenochrome Pathway', 'Adrenochrome', 'Adrenaline-quinone', 'Myeloperoxidase'] },
      { t: 'Cyclization — the point of no return', b: 'Adrenaline-quinone undergoes rapid 1,4-Michael cyclization to leuco-adrenochrome, the colorless hydroquinone (vault gives seconds–minutes only for MPO-driven conversion, not a fixed 2–5 min t½). No enzyme needed — pure chemistry, right here in the cytosol.', legend: [['#ffe14d', 'quinone → leuco-adrenochrome']], vault: ['Leuco-adrenochrome', 'Adrenochrome Pathway', 'Adrenaline-quinone'] },
      { t: 'Adrenochrome + redox cycling', b: 'Leuco-adrenochrome oxidizes to red adrenochrome, throwing off superoxide with each turn. Adrenochrome ↔ semiquinone redox cycling amplifies ROS far beyond the first oxidation — watch red particles converge on the mitochondria.', legend: [['#ff5a4d', 'adrenochrome → mitochondria'], ['#ff7a1a', 'superoxide']], vault: ['Adrenochrome', 'Adrenochrome Semiquinone Radical', 'Redox cycle'] },
      { t: 'The mitochondrial hit', b: 'Mitochondria take the hit: MAO on the outer membrane adds H₂O₂, cytochrome c oxidizes catechols in the intermembrane space, and redox cycling poisons respiration. The cluster flashes — this is the damage the protocols aim to prevent.', legend: [['#ff5a4d', 'ROS burst'], ['#ffb347', 'stressed mitochondria']], vault: ['MAO', 'Detoxification'] },
      { t: 'Detox branch — NQO1, GSH, COMT/MAO', b: 'Defenses engage. NQO1 performs a safe 2-electron reduction (skipping the radical); glutathione transferases conjugate quinones; ascorbate recycles them chemically. Meanwhile canonical clearance runs: COMT → metanephrine in cytosol, MAO → aldehyde, converging with COMT on VMA at mitochondria. Green = safe exit.', legend: [['#51ff9e', 'detoxified / excreted'], ['#7fd4ff', 'NQO1 · GSH · ascorbate']], vault: ['NQO1', 'Glutathione', 'MAO'] },
      { t: 'Fate — adrenolutin → pigment', b: 'What escapes detox rearranges (alkaline) to adrenolutin — green-fluorescent — and polymerizes toward neuromelanin-like pigment, stored in lysosome-related granules. Dark granules accumulate by the lysosome; protein arylation by quinones is the collateral damage.', legend: [['#9a7bd0', 'adrenolutin → pigment'], ['#3a3348', 'pigment granules']], vault: ['Adrenolutin', 'Adrenochrome', 'Polymerization', 'Melanins'] },
    ],
    sirtuinSteps: [
      ...
      { t: 'SIRT7 — the nucleolar specialist', b: 'SIRT7 sits in the nucleolus activating RNA polymerase I (rRNA → ribosome biogenesis — opposing SIRT1, which deacetylates TAFI68 to repress Pol I), deacetylating GATA4 (anti-hypertrophic) and repressing p21.', legend: [['#d0b8ff', 'SIRT7 — nucleolus']], vault: ['SIRT7'] },
      { t: 'SIRT2 — the cytoskeleton tuner', b: 'SIRT2 works the cytosol and rides the microtubules it deacetylates (α-tubulin); it enters the nucleus in G2/M for mitotic chromatin condensation and is reported to support autophagy via ATG4B deacetylation for LC3 processing (single-study, SIRT1 is the canonical autophagy sirtuin). Cyan flow runs along one rail.', legend: [['#51e0ff', 'SIRT2 — microtubule rail']], vault: ['SIRT2'] },
      { t: 'SIRT3 — the mitochondrial powerhouse', b: 'SIRT3 is the matrix workhorse and the only sirtuin with a human-longevity polymorphism signal (replication mixed; SIRT6 has centenarian variants too): it activates AceCS2 (fuel entry) and IDH2, deacetylates MnSOD/SOD2 (ROS detox), tunes OPA1-driven fusion and destabilizes HIF-1α. Induced by fasting and calorie restriction.', legend: [['#ffb347', 'SIRT3 — matrix deacetylation']], vault: ['SIRT3', 'HIF-1α', 'IDH2'] },
      { t: 'SIRT4 — the brake', b: 'SIRT4 is mostly an ADP-ribosyltransferase, not a deacetylase: it ADP-ribosylates and inhibits glutamate dehydrogenase (blunting amino-acid-stimulated insulin secretion; primary target) with secondary reports of MTPα / fatty-acid oxidation suppression. Calorie restriction turns it down — the mirror of SIRT1/3.', legend: [['#ff8a5a', 'SIRT4 — GDH brake']], vault: ['SIRT4'] },
    ...
    combiSteps: [
      ...
      { t: 'Ivermectin at the gate — P-gp blockade [preclinical]', b: 'At the membrane, ivermectin inhibits P-gp efflux at suprapharmacologic doses in vitro, which could raise intratumoral retention of co-administered drugs — including fenbendazole (FBZ interaction untested) — in cell models. MRP1/2/3 data are weaker. (Its antiparasitic GluCl targets do not exist in humans: the safety-margin pivot behind repurposing.)', legend: [['#3ec9a7', 'P-gp blocked — drugs stay in']], vault: ['Ivermectin', 'P-gp'] },
      { t: 'Ivermectin in the cytosol — PAK1 falls [preclinical]', b: 'Ivermectin reduces PAK1 signaling (reported as downregulation; proteasomal-degradation mechanism unproven), a hub upstream of Akt/mTOR, NF-κB, STAT3 and Wnt — plus independent YAP1 (Hippo) inhibition in cell lines. Kinase-addicted survival signaling collapses from the top down.', legend: [['#3ec9a7', 'PAK1 → Akt/mTOR · YAP1 · STAT3 off']], vault: ['PAK1', 'YAP1', 'STAT3', 'mTOR'] },
      { t: 'Ivermectin at the nucleus — import blocked [preclinical]', b: 'Ivermectin blocks KPNB1 (importin-β1) nuclear transport at the pore and suppresses Wnt/β-catenin, STAT3 and NF-κB transcription — including the PAK1–STAT3 cancer-stem-cell program (NANOG/OCT4/SOX2).', legend: [['#3ec9a7', 'KPNB1 blockade · stem program off']], vault: ['KPNB1', 'Ivermectin'] },
      ...
      { t: 'Fenbendazole starves + disinhibits — Warburg off, p53 on [preclinical]', b: 'GLUT1 downregulation plus reduced hexokinase-2 activity (direct HK2 inhibition unproven, single-study) chokes glycolysis in cell lines (Warburg blockade → NADPH/glutathione collapse), while reported MDM2/MdmX suppression stabilizes p53 → p21 arrest (unreplicated). Metabolism and the genome guardian fall in one move.', legend: [['#f5a65b', 'GLUT1/HK2 down · p53 stabilized']], vault: ['GLUT1', 'Hexokinase 2', 'p53', 'MDM2', 'Warburg Effect'] },
      { t: 'Convergence — redox catastrophe at the mitochondria', b: 'Both drugs funnel into the same endpoints from different doors: ΔΨm collapse and cytochrome-c release meet NADPH-depleted antioxidant defenses — ROS pushed past the lethal threshold (apoptosis, autophagy, pyroptosis). Except the EMT6 in-vivo null in the vault. SIRT3/SIRT6 and the NAD+ gate set sensitivity — the bridge back to the Sirtuins tour. Hypothesis only: untested clinically.', legend: [['#ff5a4d', 'ROS past lethal threshold'], ['#ffb347', 'mitochondrial collapse']], vault: ['Apoptosis', 'Autophagy', 'SIRT3', 'SIRT6', 'NAD+', 'EMT6'] },
    ],
    autophagySteps: [
      ...
      { t: 'Elongation — LC3 + p62 capture cargo', b: 'ATG7 (E1) with ATG3 lipidates LC3 onto the growing rim — after ATG4 priming and ATG5–ATG12–ATG16L1 scaffolding — while p62/SQSTM1 drags ubiquitinated cargo inside. The rim seals into a double-membrane autophagosome. SIRT1 is the canonical autophagy sirtuin (ATG5/7/LC3); a single study reports SIRT2–ATG4B support for LC3 processing — the tentative bridge back to the Sirtuins tour.', legend: [['#51ff9e', 'LC3–p62 cargo capture'], ['#51e0ff', 'SIRT2 → ATG4B (putative)']], vault: ['LC3', 'p62', 'Autophagy', 'SIRT2'] },
      ...
      { t: 'Feedback — the TFEB program', b: 'Starvation dephosphorylates TFEB, which enters the nucleus through the pore and switches on the CLEAR network: more lysosomes, more autophagy genes — with FOXO3a co-driving the program. Caloric restriction, intermittent fasting and spermidine all converge here; mTOR reactivation closes the loop.', legend: [['#7fd4ff', 'TFEB → nucleus'], ['#b79aff', 'lysosome biogenesis program']], vault: ['TFEB', 'Lysosome', 'Spermidine', 'FOXO3a'] },
    ],
    deathSteps: [
      { t: 'Crossroads — one cell, many deaths', b: 'Apoptosis, ferroptosis, necroptosis, pyroptosis and parthanatos all start in this same cytosol but exit through different doors. The vault treats them as one crosstalk network — this tour walks each door in turn, all preclinical cell biology, no clinical claims.', legend: [['#ffb347', 'mitochondrial door'], ['#51ff9e', 'membrane door'], ['#b79aff', 'nuclear door']], vault: ['Regulated Cell Death', 'Apoptosis', 'Ferroptosis', 'Necroptosis', 'Parthanatos', 'Pyroptosis'] },
      ...
      { t: 'Ferroptosis — GPX4 fails, membranes rust', b: 'When glutathione runs out or GPX4 is blocked, lipid peroxides spread unchecked through membranes — iron-dependent rust instead of clean caspase cuts. The plasma membrane is the victim here; the IVM × FBZ tour ends at this same ROS threshold from the drug side.', legend: [['#ff5a4d', 'lipid peroxidation spread'], ['#51ff9e', 'GSH/GPX4 defense line']], vault: ['Ferroptosis', 'GPX4', 'Glutathione', 'Lipid Peroxidation'] },
      { t: 'Necroptosis — RIPK3–MLKL rupture the membrane', b: 'When caspase-8 is blocked, RIPK1/RIPK3 phosphorylate MLKL, which oligomerizes and punches holes in the plasma membrane from the inside. Unlike apoptosis the cell bursts — releasing DAMPs that warn neighbors. Inflammatory by design.', legend: [['#f5a65b', 'RIPK3 → MLKL pores'], ['#ff5a4d', 'membrane rupture']], vault: ['Necroptosis', 'RIPK1', 'RIPK3', 'MLKL'] },
      { t: 'Pyroptosis — NLRP3–GSDMD pores burn the membrane', b: 'Inflammasomes (e.g. NLRP3) activate Caspase-1, which cleaves gasdermin D (GSDMD): the N-fragment oligomerizes into plasma-membrane pores. IL-1β/IL-18 spill out as the cell swells and bursts — inflammatory like necroptosis, but caspase-1/gasdermin-driven.', legend: [['#f5a65b', 'NLRP3 → Caspase-1'], ['#ff5a4d', 'GSDMD pores → IL-1β release']], vault: ['Pyroptosis', 'NLRP3', 'Caspase-1', 'GSDMD', 'IL-1β'] },
    ...
    redoxSteps: [
      ...
      { t: 'The return — stronger mitochondria', b: 'NRF2 (NFE2L2) output converges with the PGC-1α mitochondrial-biogenesis program (respiratory-factor NRF-2/GABP, not NFE2L2, is the direct PGC-1α partner), tuned by SIRT1/SIRT3 and FOXO3a — the Sirtuins-tour bridge. New mitochondria breathe cleaner: the adaptation that makes the next identical stress hit softer.', legend: [['#51ff9e', 'PGC-1α biogenesis'], ['#ffb347', 'SIRT3-tuned mitochondria']], vault: ['PGC-1α', 'Mitochondrial Biogenesis', 'SIRT3', 'FOXO3a', 'SIRT6'] },
    ...
    protoSteps: [
      { t: 'Stabilized trigger — carbazochrome + AMM [speculative]', b: 'Free adrenochrome (the Pathway tour) is unstable and cardiotoxic — this protocol never uses it. Hypothesized: carbazochrome (semicarbazone-stabilized) and AMM, the adrenochrome–aminoguanidine hybrid — but unresolved whether stabilized derivatives retain any redox-cycling trigger; vault chemistry suggests carbazochrome is redox-silent. Any pulsed mitochondrial superoxide signal is asserted, not evidenced.', legend: [['#ff5a4d', 'hypothesized redox pulse'], ['#ffb347', 'matrix-confined ROS?']], vault: ['Carbazochrome', 'Adrenochrome monoaminoguanidine', 'Adrenochrome'] },
      { t: 'MRR pillar — MB shuttles, NAD+ fuels, urolithin clears [speculative]', b: 'Mitohormetic Redox-Relay (hypothesis): methylene blue shuttles electrons (NADH → cytochrome c, Complex I/III bypass) in mg-total low doses (wellness 0.5–4 mg total; >2 mg/kg flips pro-oxidant per vault — not a dosing recommendation), NR/NMN replete NAD+ for SIRT1/3, creatine buffers ATP, resveratrol sensitizes SIRT1 — and urolithin A clears the mitochondria that fail via mitophagy. Trigger, fuel, cleanup in one relay.', legend: [['#3ec9a7', 'MB electron shuttle'], ['#7fd4ff', 'NAD+ fuel'], ['#4ad6b5', 'urolithin A clearance']], vault: ['Methylene blue', 'NAD+', 'Urolithin A', 'Resveratrol', 'Creatine'] },
      { t: 'SRAC pillar — rapamycin quiets, fisetin clears [speculative]', b: 'SASP-Remodeling Aminochrome Complex, strictly sequential (hypothesis; durations stipulated, not evidenced): Phase 1 rapamycin suppresses SASP via mTORC1 (established); AMM + MB co-administration for SASP suppression is speculative. Washout before Phase 2 fisetin strikes senescent cells into apoptosis. Note fisetin–COMT/SAMe interaction unaddressed. GlyNAC buffers redox across both phases. Never concurrent.', legend: [['#8a6ff0', 'rapamycin — SASP quiet'], ['#ff5a4d', 'fisetin — senolysis']], vault: ['Rapamycin', 'Fisetin', 'Senolytic', 'SASP'] },
      { t: 'GOPS pillar — trap AGEs, digest damage [speculative]', b: 'Glyco-Oxidative Proteostasis Shield (hypothesis): free aminoguanidine traps methylglyoxal/glyoxal in the literature — whether the bound AG moiety of AMM retains this (hydrazone-consumed hydrazine, pending prodrug-hydrolysis proof) is unresolved; mild ER hormesis raising chaperones is hypothesis-only; spermidine drives macroautophagy of glycated proteins; carnosine as metal-chelator/Fenton suppressor is co-administered hypothesis without independent vault evidence.', legend: [['#ffc357', 'AG — AGE trap?'], ['#51ff9e', 'spermidine clearance']], vault: ['Aminoguanidine', 'Spermidine', 'Carnosine', 'GlyNAC'] },
      ...
      { t: 'The window — why this is 8/10 hard [speculative]', b: 'Inverted-U, not a plateau (hypothetical window — no established adrenochrome dose; illustrative nM pulsed vs µM+ sustained framing only): overshoot is ferroptosis, methemoglobinemia and cardiomyopathy. Guardrails from the vault: G6PD screening, co-oximetry (note MB falsifies pulse oximetry), MB + SSRI serotonin risk. HRV gating, IV NAD+ preference and oral-AG histamine risk are unsourced — dropped. Hypothesis only — not clinical.', legend: [['#51ff9e', 'window — adaptation'], ['#ff5a4d', 'overshoot — damage']], vault: ['Mitohormesis', 'Methemoglobinemia', 'G6PD', 'Ferroptosis'] },
    ],
    metabSteps: [
    ...
    nmSteps: [
      ...
      { t: 'Safe packing — VMAT2 vs DAT', b: 'Fresh dopamine is pumped into vesicles by VMAT2 for release, and recaptured at the membrane by the dopamine transporter (DAT). Packed dopamine is safe dopamine — only the dopamine left sitting in cytosol can oxidize.', legend: [['#7fd4ff', 'VMAT2 vesicle packing'], ['#51ff9e', 'DAT reuptake']], vault: ['Vesicular Monoamine Transporter 2', 'Dopamine Transporter'] },
      ...
      { t: 'Cyclization — dopachrome forks', b: 'The quinone cyclizes to dopachrome: DCT tautomerizes it toward DHICA-rich eumelanin while spontaneous decay gives DHI-based eumelanin; pheomelanin is the separate upstream branch (cysteine addition to dopaquinone → benzothiazine units). Substantia-nigra neuromelanin is a mixed pheo/eumelanin copolymer where DCT routing is minor. The branch decides the pigment’s iron-handling character.', legend: [['#9a7bd0', 'dopachrome fork'], ['#3a3348', 'eumelanin vs pheomelanin']], vault: ['Dopachrome', 'Dopachrome tautomerase', '5,6-indolequinone', 'Eumelanin', 'Pheomelanin'] },
    ...
    comtSteps: [
      ...
      { t: 'The genotype dial — Val158Met', b: 'The vault’s COMT genotype docs: Val/Val shows ~3–4× higher activity in vitro (modest in-vivo PFC shift; resilient under stress, thinner prefrontal signal), Met/Met clears slowly (richer prefrontal dopamine, stress-fragile). Same enzyme, different tempo — prefrontal cortex lives closest to this dial.', legend: [['#b79aff', 'Val158Met tempo']], vault: ['Val158Met', 'COMT', 'Prefrontal Cortex'] },
      { t: 'Brakes and polyphenols — inhibitors in the vault', b: 'Parkinson drugs tolcapone, entacapone and opicapone brake COMT to stretch L-DOPA; green-tea catechins (EGCG), quercetin and luteolin inhibit COMT in vitro / at high supplemental doses, but normal tea drinking does not meaningfully impair COMT — the genotype-optimization angle the COMT notes are built around.', legend: [['#8a6ff0', 'COMT inhibitors'], ['#4ad6b5', 'polyphenol modulators']], vault: ['Tolcapone', 'Entacapone', 'Opicapone', 'Green tea', 'Quercetin', 'Luteolin'] },
      { t: 'When clearance fails — quinone spillover', b: 'Catechols that escape COMT + MAO can oxidize into o-quinones (theoretical COMT-blockade shift) — the on-ramp to both the Pathway tour (adrenaline → adrenochrome) and the Neuromelanin tour (dopamine → pigment). Clearance is what keeps signaling molecules from becoming quinone chemistry.', legend: [['#ff5a4d', 'quinone spillover'], ['#9a7bd0', '→ pigment paths']], vault: ['Dopamine o-quinone', 'Adrenochrome', 'Neuromelanin'] },
    ],
    oskmSteps: [
      { t: 'Aged chromatin — clock ticking, LINE-1 awake', b: 'Old nuclei globally lose H3K9me3 heterochromatin (focally retained in SAHF), LINE-1 retrotransposons stir, and the epigenetic clock advances — the vault’s aging-epigenetics docs. The genome is intact; its packaging has forgotten itself.', legend: [['#8a6ff0', 'H3K9me3 erosion'], ['#ff8a5a', 'LINE-1 stirring']], vault: ['H3K9me3', 'LINE-1', 'Epigenetic Clock'] },
      { t: 'Four factors arrive — OSKM bind', b: 'Oct4, Sox2 and Klf4 enter through the pore and clamp onto closed chromatin as pioneer factors — binding where nothing else can — while c-Myc amplifies accessibility at open sites. Delivery through the nuclear pore is the first visible move.', legend: [['#3ec9a7', 'OSKM → nucleus']], vault: ['OSKM', 'Oct4', 'Sox2', 'Klf4', 'c-Myc'] },
      { t: 'Guards step aside — heterochromatin opens', b: 'SIRT6-guarded heterochromatin (the Sirtuins tour’s chromatin guardian) loosens as OSKM recruit remodelers; SIRT1-repressed loci reopen. Retroelement derepression risks innate-immune and p53 barriers, so LINE-1 must stay leashed while the rest opens.', legend: [['#b79aff', 'chromatin opening'], ['#8a6ff0', 'SIRT6 watch']], vault: ['SIRT6', 'SIRT1', 'LINE-1', 'Cellular Reprogramming'] },
      ...
      { t: 'Nucleolar reboot — ribosomes return', b: 'The nucleolus reignites: rRNA transcription and ribosome biogenesis resume youthful output — c-Myc directly drives this Pol I program — the mirror image of the SIRT7 step in the Sirtuins tour. Protein-building capacity is an expected readout of rejuvenation.', legend: [['#d0b8ff', 'nucleolar reignition']], vault: ['Ribosome Biogenesis', 'SIRT7', 'OSKM', 'c-Myc'] },
  ...
  zh: {
    ...
    adrenoSteps: [
      { t: '邊緣的腎上腺素', b: '腎上腺素匯集於胞質與胞外液。微量金屬、超氧陰離子與髓過氧化物酶衍生氧化劑奪去一個電子：半醌自由基，再到腎上腺素醌。綠色粒子自胞外流入。', legend: [['#51ff9e', '腎上腺素流入']], vault: ['Adrenochrome Pathway', 'Adrenochrome', 'Adrenaline-quinone', 'Myeloperoxidase'] },
      { t: '環化——不歸點', b: '腎上腺素醌經快速 1,4-Michael 環化生成無色的白腎上腺色素（知識庫僅給 MPO 驅動轉換的秒至分鐘級，無固定 2–5 分鐘半衰期）。無需酶——純化學，就在胞質中發生。', legend: [['#ffe14d', '醌 → 白腎上腺色素']], vault: ['Leuco-adrenochrome', 'Adrenochrome Pathway', 'Adrenaline-quinone'] },
      { t: '腎上腺色素與氧化還原循環', b: '白腎上腺色素氧化為紅色腎上腺色素，每轉一圈釋出超氧陰離子。腎上腺色素 ↔ 半醌的氧化還原循環將 ROS 放大到遠超初次氧化——看紅色粒子匯聚到粒線體。', legend: [['#ff5a4d', '腎上腺色素 → 粒線體'], ['#ff7a1a', '超氧陰離子']], vault: ['Adrenochrome', 'Adrenochrome Semiquinone Radical', 'Redox cycle'] },
      { t: '粒線體受擊', b: '粒線體首當其衝：外膜 MAO 添產 H₂O₂，膜間隙的細胞色素 c 氧化兒茶酚，氧化還原循環毒害呼吸。星團閃爍——這正是各方案要預防的損傷。', legend: [['#ff5a4d', 'ROS 爆發'], ['#ffb347', '受壓粒線體']], vault: ['MAO', 'Detoxification'] },
      { t: '解毒分支——NQO1、GSH、COMT/MAO', b: '防禦啟動。NQO1 做安全的雙電子還原（跳過自由基）；穀胱甘肽轉移酶結合醌類；維生素 C 化學性回收。同時經典清除運行：胞質 COMT → 甲氧基腎上腺素，粒線體 MAO → 醛，並與 COMT 匯聚成 VMA。綠色＝安全出口。', legend: [['#51ff9e', '已解毒／排出'], ['#7fd4ff', 'NQO1 · GSH · 維生素 C']], vault: ['NQO1', 'Glutathione', 'MAO'] },
      { t: '結局——腎上腺螢光素 → 色素', b: '逃過解毒者（鹼性）重排為腎上腺螢光素——綠色螢光——並聚合成類神經黑色素，存於溶酶體相關顆粒。深色顆粒在溶酶體旁累積；醌類的蛋白芳基化是附帶損傷。', legend: [['#9a7bd0', '腎上腺螢光素 → 色素'], ['#3a3348', '色素顆粒']], vault: ['Adrenolutin', 'Adrenochrome', 'Polymerization', 'Melanins'] },
    ],
    sirtuinSteps: [
      ...
      { t: 'SIRT7——核仁專家', b: 'SIRT7 居於核仁，活化 RNA 聚合酶 I（rRNA → 核糖體生源——與 SIRT1 去乙醯化 TAFI68 以抑制 Pol I 相反），去乙醯化 GATA4（抗心肌肥大）並抑制 p21。', legend: [['#d0b8ff', 'SIRT7——核仁']], vault: ['SIRT7'] },
      { t: 'SIRT2——細胞骨架調音師', b: 'SIRT2 在胞質工作，沿著它去乙醯化的微管（α-微管蛋白）運行；G2/M 期入核促有絲分裂染色質凝縮；據單篇研究報導經 ATG4B 去乙醯化支持 LC3 加工以助自噬（SIRT1 才是典型自噬 sirtuin）。青色粒子沿一條軌道流動。', legend: [['#51e0ff', 'SIRT2——微管軌道']], vault: ['SIRT2'] },
      { t: 'SIRT3——粒線體主力', b: 'SIRT3 是基質主力，也是唯一具人類長壽多態性訊號的 sirtuin（重複驗證不一；SIRT6 亦有百歲人瑞變異）：活化 AceCS2（燃料入口）與 IDH2，去乙醯化 MnSOD/SOD2（ROS 解毒），調節 OPA1 介導的融合，並使 HIF-1α 失穩。禁食與熱量限制誘導它。', legend: [['#ffb347', 'SIRT3——基質去乙醯化']], vault: ['SIRT3', 'HIF-1α', 'IDH2'] },
      { t: 'SIRT4——煞車', b: 'SIRT4 主要是 ADP-核糖基轉移酶而非去乙醯化酶：ADP-核糖基化並抑制穀氨酸脫氫酶（鈍化胺基酸刺激的胰島素分泌；主要標靶），另有 MTPα／脂肪酸氧化抑制的次級報導。熱量限制把它調低——與 SIRT1/3 互為鏡像。', legend: [['#ff8a5a', 'SIRT4——GDH 煞車']], vault: ['SIRT4'] },
    ...
    combiSteps: [
      ...
      { t: '伊維菌素守門——P-gp 封鎖［臨床前］', b: '在細胞膜，伊維菌素於超藥理濃度在體外抑制 P-gp 外排，可能提高併用藥物（含芬苯達唑，FBZ 交互作用未驗證）在細胞模型中的滯留。MRP1/2/3 證據較弱。（其抗寄生蟲 GluCl 標靶在人類不存在：重新定位背後的安全餘裕轉折。）', legend: [['#3ec9a7', 'P-gp 被封——藥物留在胞內']], vault: ['Ivermectin', 'P-gp'] },
      { t: '伊維菌素在胞質——PAK1 倒下［臨床前］', b: '伊維菌素降低 PAK1 訊號（報導為下調；蛋白酶體降解機制未確立）——PAK1 是 Akt/mTOR、NF-κB、STAT3 與 Wnt 上游的樞紐；另在細胞株獨立抑制 YAP1（Hippo）。激酶依賴的存活訊號自上而下崩潰。', legend: [['#3ec9a7', 'PAK1 → Akt/mTOR · YAP1 · STAT3 關閉']], vault: ['PAK1', 'YAP1', 'STAT3', 'mTOR'] },
      { t: '伊維菌素在核——進口被封［臨床前］', b: '伊維菌素在核孔阻斷 KPNB1（importin-β1）核運輸，並抑制 Wnt/β-catenin、STAT3 與 NF-κB 轉錄——包括 PAK1–STAT3 癌症幹細胞計畫（NANOG/OCT4/SOX2）。', legend: [['#3ec9a7', 'KPNB1 封鎖 · 幹細胞計畫關閉']], vault: ['KPNB1', 'Ivermectin'] },
      ...
      { t: '芬苯達唑斷糧＋解鎖——瓦伯格關、p53 開［臨床前］', b: 'GLUT1 下調加己糖激酶 2 活性下降（直接抑制 HK2 未確立、單篇研究），在細胞株掐住糖解（瓦伯格阻斷 → NADPH／穀胱甘肽崩潰）；同時報導的 MDM2/MdmX 抑制穩定 p53 → p21 停滯（未被重複驗證）。代謝與基因組守衛一舉而下。', legend: [['#f5a65b', 'GLUT1/HK2 下降 · p53 穩定']], vault: ['GLUT1', 'Hexokinase 2', 'p53', 'MDM2', 'Warburg Effect'] },
      { t: '匯聚——粒線體的氧化還原災難', b: '兩種藥從不同入口匯入相同終點：ΔΨm 崩潰與細胞色素 c 釋放，遇上 NADPH 耗竭的抗氧化防禦——ROS 被推過致死閾值（凋亡、自噬、焦亡）。知識庫另有 EMT6 體內無效例。SIRT3/SIRT6 與 NAD+ 閘門決定敏感度——回到 Sirtuins 導覽的橋樑。純屬假說：臨床未驗證。', legend: [['#ff5a4d', 'ROS 超過致死閾值'], ['#ffb347', '粒線體崩潰']], vault: ['Apoptosis', 'Autophagy', 'SIRT3', 'SIRT6', 'NAD+', 'EMT6'] },
    ],
    autophagySteps: [
      ...
      { t: '延伸——LC3＋p62 捕獲貨物', b: 'ATG7（E1）與 ATG3 把 LC3 脂化到生長中的膜緣——經 ATG4 引發與 ATG5–ATG12–ATG16L1 支架——p62/SQSTM1 把泛素化的貨物拖進來。膜緣閉合成雙層膜自噬體。SIRT1 才是典型自噬 sirtuin（ATG5/7/LC3）；單篇研究報導 SIRT2–ATG4B 支持 LC3 加工——暫定性的 Sirtuins 橋樑。', legend: [['#51ff9e', 'LC3–p62 捕獲'], ['#51e0ff', 'SIRT2 → ATG4B（暫定）']], vault: ['LC3', 'p62', 'Autophagy', 'SIRT2'] },
      ...
      { t: '回饋——TFEB 計畫', b: '飢餓使 TFEB 去磷酸化，經核孔入核啟動 CLEAR 網路：更多溶酶體、更多自噬基因——FOXO3a 共同驅動此程式。熱量限制、間歇性禁食與亞精胺都匯聚於此；mTOR 再活化則關閉迴路。', legend: [['#7fd4ff', 'TFEB → 入核'], ['#b79aff', '溶酶體新生計畫']], vault: ['TFEB', 'Lysosome', 'Spermidine', 'FOXO3a'] },
    ],
    deathSteps: [
      { t: '十字路口——一顆細胞，多種死法', b: '凋亡、鐵死亡、壞死性凋亡、焦亡與 Parthanatos（聚ADP核糖死亡）都從同一個胞質出發，卻走不同的門。知識庫把它們視為一個交互網路——本導覽逐一走過每扇門，皆為臨床前細胞生物學，不涉臨床宣稱。', legend: [['#ffb347', '粒線體之門'], ['#51ff9e', '細胞膜之門'], ['#b79aff', '細胞核之門']], vault: ['Regulated Cell Death', 'Apoptosis', 'Ferroptosis', 'Necroptosis', 'Parthanatos', 'Pyroptosis'] },
      ...
      { t: '鐵死亡——GPX4 失守，膜生鏽', b: '穀胱甘肽耗竭或 GPX4 被抑制時，脂質過氧化物在膜中失控蔓延——是鐵依賴的鏽蝕，而非乾淨的 caspase 切割。受害者是細胞膜；IVM × FBZ 導覽從藥物側匯入同一個 ROS 閾值。', legend: [['#ff5a4d', '脂質過氧化蔓延'], ['#51ff9e', 'GSH/GPX4 防線']], vault: ['Ferroptosis', 'GPX4', 'Glutathione', 'Lipid Peroxidation'] },
      { t: '壞死性凋亡——RIPK3–MLKL 擊破細胞膜', b: '當 caspase-8 被阻斷，RIPK1/RIPK3 磷酸化 MLKL，後者寡聚化由內向外在細胞膜打洞。與凋亡不同，細胞會爆裂——釋出 DAMPs 警告鄰居。發炎是其本意。', legend: [['#f5a65b', 'RIPK3 → MLKL 打孔'], ['#ff5a4d', '細胞膜破裂']], vault: ['Necroptosis', 'RIPK1', 'RIPK3', 'MLKL'] },
      { t: '焦亡——NLRP3–GSDMD 打孔燒膜', b: '發炎小體（如 NLRP3）活化 Caspase-1，切割 gasdermin D（GSDMD）：N 端片段寡聚化在細胞膜打孔。IL-1β/IL-18 外洩，細胞腫脹爆裂——與壞死性凋亡同樣發炎，但由 caspase-1/gasdermin 驅動。', legend: [['#f5a65b', 'NLRP3 → Caspase-1'], ['#ff5a4d', 'GSDMD 打孔 → IL-1β 釋放']], vault: ['Pyroptosis', 'NLRP3', 'Caspase-1', 'GSDMD', 'IL-1β'] },
      { t: 'Parthanatos（聚ADP核糖死亡）——PARP1 過載，AIF 北上', b: '大量 DNA 損傷過度活化 PARP1，PAR 聚合物淹沒細胞。PAR 把凋亡誘導因子（AIF）從粒線體拖入細胞核，以非 caspase 方式撕碎染色質。一場經核孔的粒線體→核死亡行軍。', legend: [['#b79aff', 'PARP1 → PAR 洪流'], ['#7fd4ff', 'AIF 粒線體 → 核']], vault: ['Parthanatos', 'PARP1', 'AIF', 'NAD+'] },
    ],
    redoxSteps: [
      ...
      { t: '回報——更強的粒線體', b: 'NRF2（NFE2L2）產出匯入 PGC-1α 粒線體新生程式（直接夥伴是呼吸因子 NRF-2/GABP，而非 NFE2L2），由 SIRT1/SIRT3 與 FOXO3a 調音——通往 Sirtuins 導覽的橋。新粒線體呼吸得更乾淨：讓下一次相同壓力變輕的適應。', legend: [['#51ff9e', 'PGC-1α 新生'], ['#ffb347', 'SIRT3 調音的粒線體']], vault: ['PGC-1α', 'Mitochondrial Biogenesis', 'SIRT3', 'FOXO3a', 'SIRT6'] },
      { t: '曲線——小劑量訓練 vs 過載摧毀', b: '低劑量訓練，高劑量摧毀：運動、禁食與飲食來源的毒物興奮劑（知識庫的運動／飲食毒物興奮文件）在上升坡；腎上腺色素 ROS 爆發與鐵死亡在峰頂之後。相同的分子，相反的結局——劑量就是差別。', legend: [['#51ff9e', '有益壓力——適應'], ['#ff5a4d', '過載——損傷']], vault: ['Hormesis', 'Exercise Hormesis', 'Hormetin', 'Mitohormesis'] },
    ],
    saspSteps: [
      ...
      { t: '警報——胞質染色質觸發 cGAS-STING', b: '外洩的染色質碎片落入胞質，cGAS-STING DNA 感測器誤把自己當入侵者；同時釋出的 HMGB1 經 TLR4/RAGE 傳入 NF-κB。STING 點燃干擾素與 NF-κB 程式——知識庫中 cGAS-STING 在衰老的文件正位於這個交接點。', legend: [['#ffc357', '胞質染色質'], ['#ff8a5a', 'cGAS-STING 警報']], vault: ['cGAS', 'STING', 'cGAS-STING Pathway', 'HMGB1'] },
      { t: '工廠——NF-κB 開啟 SASP', b: 'NF-κB（知識庫另有 C/EBPβ 協同）把停滯的細胞變成分泌工廠：IL-1α 為上游放大器，帶動 IL-6、IL-1β、趨化因子與蛋白酶——衰老相關分泌表型。短暫爆發有助傷口癒合；慢性則具腐蝕性。', legend: [['#ff5a4d', 'NF-κB → SASP 基因'], ['#f5a65b', 'IL-6 · IL-1β']], vault: ['NF-κB', 'SASP', 'IL-6', 'IL-1β'] },
      ...
      { t: '安靜或清除——衰老形態調節 vs 衰老清除', b: '兩種知識庫策略收尾：衰老形態調節劑（知識庫中的芹菜素類）讓細胞活著但安靜下來；fisetin 等衰老清除劑把衰老細胞推入凋亡——fisetin 文件中 CXCL12 下降、內皮功能恢復。', legend: [['#4ad6b5', '衰老形態調節——安靜'], ['#ff5a4d', '衰老清除——清除']], vault: ['Senomorphic', 'Senolytic', 'Fisetin', 'SASP'] },
    ],
    protoSteps: [
      { t: '穩定的觸發——carbazochrome＋AMM［假說］', b: '游離腎上腺色素（路徑導覽的主角）不穩定且有心臟毒性——本方案從不使用它。假設性：carbazochrome（縮氨脲穩定）與 AMM（腎上腺色素–胺基胍複合物）——但穩定衍生物是否保留氧化還原循環觸發未解；知識庫化學傾向其具氧化還原沉默性。任何脈衝粒線體超氧訊號皆為斷言，非證據。', legend: [['#ff5a4d', '假設性氧化還原脈衝'], ['#ffb347', '侷限於基質的 ROS？']], vault: ['Carbazochrome', 'Adrenochrome monoaminoguanidine', 'Adrenochrome'] },
      { t: 'MRR 支柱——MB 穿梭、NAD+ 供能、尿石素清除［假說］', b: '粒線體毒物興奮氧化還原接力（假說）：亞甲藍穿梭電子（NADH → 細胞色素 c，複合體 I/III 繞道），採 mg 總量低劑量（健康 0.5–4 mg 總量；知識庫指 >2 mg/kg 轉為促氧化——非給藥建議），NR/NMN 補充 NAD+ 供 SIRT1/3，肌酸緩衝 ATP，白藜蘆醇增敏 SIRT1——尿石素 A 以粒線體自噬清除失敗者。觸發、燃料、清理一條龍。', legend: [['#3ec9a7', 'MB 電子穿梭'], ['#7fd4ff', 'NAD+ 燃料'], ['#4ad6b5', '尿石素 A 清除']], vault: ['Methylene blue', 'NAD+', 'Urolithin A', 'Resveratrol', 'Creatine'] },
      { t: 'SRAC 支柱——雷帕黴素安靜、fisetin 清除［假說］', b: 'SASP 重塑複合物，嚴格依序（假說；時程為規定非證據）：第 1 階段雷帕黴素經 mTORC1 壓制 SASP（已確立）；AMM＋MB 併用壓制 SASP 屬推測。洗脫後第 2 階段 fisetin 把衰老細胞打入凋亡。注意 fisetin–COMT/SAMe 交互作用未處理。GlyNAC 全程緩衝氧化還原。絕不併用。', legend: [['#8a6ff0', '雷帕黴素——SASP 安靜'], ['#ff5a4d', 'fisetin——衰老清除']], vault: ['Rapamycin', 'Fisetin', 'Senolytic', 'SASP'] },
      { t: 'GOPS 支柱——捕捉 AGE、消化損傷［假說］', b: '糖氧化蛋白質穩態盾（假說）：游離胺基胍捕捉甲基乙二醛文獻明確——AMM 結合態 AG 基團是否保留此活性（腙鍵耗去肼基，待前藥水解證明）未解；輕度內質網毒物興奮升伴侶蛋白僅為假說；亞精胺驅動巨自噬清除糖化蛋白；肌肽金屬螯合/Fenton 抑制為併用假說，無獨立知識庫證據。', legend: [['#ffc357', 'AG——AGE 陷阱？'], ['#51ff9e', '亞精胺清除']], vault: ['Aminoguanidine', 'Spermidine', 'Carnosine', 'GlyNAC'] },
      ...
      { t: '窗口——為何難度 8/10［假說］', b: '倒 U 形而非平台（假設性窗口——腎上腺色素尚無確立劑量；nM 脈衝 vs µM+ 持續僅為示意框架）：超標則是鐵死亡、變性血紅素血症與心肌病。知識庫的護欄：G6PD 篩檢、碳氧血紅素監測（注意 MB 干擾脈搏血氧）、MB＋SSRI 血清素風險。HRV 閘門、IV NAD+ 優先與口服 AG 組織胺風險無來源——已刪除。純屬假說——非臨床。', legend: [['#51ff9e', '窗口——適應'], ['#ff5a4d', '超標——損傷']], vault: ['Mitohormesis', 'Methemoglobinemia', 'G6PD', 'Ferroptosis'] },
    ],
    metabSteps: [
    ...
    nmSteps: [
      ...
      { t: '安全包裝——VMAT2 vs DAT', b: '新鮮多巴胺由 VMAT2 打包進囊泡待釋放，並由膜上的多巴胺轉運體（DAT）回收。包好的多巴胺是安全的多巴胺——只有滯留胞質的才會氧化。', legend: [['#7fd4ff', 'VMAT2 囊泡包裝'], ['#51ff9e', 'DAT 回收']], vault: ['Vesicular Monoamine Transporter 2', 'Dopamine Transporter'] },
      ...
      { t: '環化——多巴色素分岔', b: '醌環化成多巴色素：DCT 將其互變異構為富含 DHICA 的真黑素，無 DCT 時自發衰變成 DHI 型真黑素；褐黑素是另一條上游分支（半胱氨酸加成多巴醌 → 苯並噻嗪單元）。黑質神經黑色素是混合共聚物，DCT 分流作用次要。分支決定色素處理鐵的性格。', legend: [['#9a7bd0', '多巴色素分岔'], ['#3a3348', '真黑素 vs 褐黑素']], vault: ['Dopachrome', 'Dopachrome tautomerase', '5,6-indolequinone', 'Eumelanin', 'Pheomelanin'] },
    ...
    comtSteps: [
      ...
      { t: 'COMT 甲基化——胞質的關閉開關', b: '兒茶酚-O-甲基轉移酶把 SAM 上的甲基（需 Mg²⁺）轉到兒茶酚的 –OH 上，使其靜默：多巴胺 → 3-甲氧基酪胺，正腎上腺素 → 去甲變腎上腺素。可溶性 COMT 在胞質工作；膜結合型守衛突觸。', legend: [['#ffc357', 'COMT 甲基化']], vault: ['COMT', 'Catechols', 'SAM', 'Methyl groups', 'Magnesium'] },
      ...
      { t: '基因型轉盤——Val158Met', b: '知識庫的 COMT 基因型文件：Val/Val 在體外活性高約 3–4 倍（在體前額葉位移較小；抗壓韌、前額葉訊號較薄），Met/Met 清得慢（前額葉多巴胺較濃、壓力下較脆）。同一種酶，不同節奏——前額葉皮質離這個轉盤最近。', legend: [['#b79aff', 'Val158Met 節奏']], vault: ['Val158Met', 'COMT', 'Prefrontal Cortex'] },
      { t: '煞車與多酚——知識庫中的抑制劑', b: '帕金森藥物 tolcapone、entacapone 與 opicapone 煞停 COMT 以延長 L-DOPA；綠茶兒茶素（EGCG）、槲皮素與木犀草素在體外／高補充劑量抑制 COMT，但日常飲茶不顯著影響 COMT——正是 COMT 筆記圍繞的基因型優化角度。', legend: [['#8a6ff0', 'COMT 抑制劑'], ['#4ad6b5', '多酚調節']], vault: ['Tolcapone', 'Entacapone', 'Opicapone', 'Green tea', 'Quercetin', 'Luteolin'] },
      { t: '清除失效時——醌外溢', b: '逃過 COMT＋MAO 的兒茶酚可氧化成鄰醌（理論上的 COMT 阻斷轉移）——通往路徑導覽（腎上腺素 → 腎上腺色素）與神經黑色素導覽（多巴胺 → 色素）的匝道。清除正是讓訊號分子免於淪為醌化學的原因。', legend: [['#ff5a4d', '醌外溢'], ['#9a7bd0', '→ 色素路徑']], vault: ['Dopamine o-quinone', 'Adrenochrome', 'Neuromelanin'] },
    ],
    oskmSteps: [
      { t: '老化的染色質——時鐘走動、LINE-1 醒來', b: '老細胞核整體流失 H3K9me3 異染色質（SAHF 局灶保留），LINE-1 反轉錄轉座子蠢動，表觀遺傳時鐘前進——知識庫的老化表觀遺傳文件。基因組完好；包裝忘了自己。', legend: [['#8a6ff0', 'H3K9me3 磨損'], ['#ff8a5a', 'LINE-1 蠢動']], vault: ['H3K9me3', 'LINE-1', 'Epigenetic Clock'] },
      { t: '四因子駕到——OSKM 結合', b: 'Oct4、Sox2 與 Klf4 經核孔入核，以先鋒因子箝住關閉的染色質——結合在別無他物能結合之處；c-Myc 在開放位點放大可及性。經核孔的遞送是第一個可見動作。', legend: [['#3ec9a7', 'OSKM → 入核']], vault: ['OSKM', 'Oct4', 'Sox2', 'Klf4', 'c-Myc'] },
      { t: '守衛讓路——異染色質鬆開', b: 'SIRT6 守衛的異染色質（Sirtuins 導覽中的染色質守衛）隨 OSKM 招募重塑器而鬆動；SIRT1 壓制的位點重開。反轉錄轉座子去抑制會觸發先天免疫與 p53 屏障，故其餘鬆開時 LINE-1 必須拴住。', legend: [['#b79aff', '染色質鬆開'], ['#8a6ff0', 'SIRT6 看守']], vault: ['SIRT6', 'SIRT1', 'LINE-1', 'Cellular Reprogramming'] },
      ...
      { t: '核仁重啟——核糖體歸來', b: '核仁重新點火：rRNA 轉錄與核糖體新生恢復年輕產量——c-Myc 直接驅動此 Pol I 程式——Sirtuins 導覽中 SIRT7 步驟的鏡像。蛋白質建造產能是回春的預期讀出。', legend: [['#d0b8ff', '核仁重新點火']], vault: ['Ribosome Biogenesis', 'SIRT7', 'OSKM', 'c-Myc'] },
...
/* zh parity: eustress → 有益壓力, senomorphic/senolytic fully translated, HMGB1 split from cGAS, Parthanatos with CJK gloss. */
...
export function initCellPage({ lang = 'en', canvas, els }) {
  ...
  const S = {
    ...
    nrfPer: marker(0x4ad6b5, peroxAnchor.clone(), 0.26),
  ...
  const MARKER_GROUPS = { sirtuin: sirtuinMarkers, adreno: adrenoMarkers, combi: combiMarkers, auto: autoMarkers, death: deathMarkers, redox: redoxMarkers, sasp: saspMarkers, proto: protoMarkers, metab: metabMarkers, nm: nmMarkers, comt: comtMarkers, oskm: oskmMarkers };
  ...
  function setEmitters(list) {
    ...
    flows.visible = true;
    const want = list.reduce((s, e) => s + e.count, 0);
    if (want > FN) console.warn(`[inside-the-cell] emitters want ${want} > pool ${FN}; truncating`);
    let i = 0;
    for (const e of list) {
      tmpC.set(e.color);
  ...
  const DEATH_CAM = [
    ...
    { cam: [MEMB.x + 2, MEMB.y + 2, MEMB.z + 10], tgt: MEMB.toArray(), hi: ['membrane'], fl: [{ a: CYTO, b: MEMB, color: '#f5a65b', count: 240, spread: 0.5 }, { a: CYTO.clone().add(V3(0, 1.5, -1)), b: MEMB, color: '#ff5a4d', count: 220, spread: 0.5 }], mk: [S.deathMem] },
  ...
  const NRF_PER = peroxAnchor.clone();
  const REDOX_CAM = [
  ...
  function applyStep() {
    ...
    for (const [key, group] of Object.entries(MARKER_GROUPS)) {
      const show = mode === key;
      for (const m of group) m.visible = show && (chore.mk || []).includes(m);
    }
  ...
  function setMode(m, keepStep) {
    ...
    if (m === 'explore') {
      setEmitters([]);
      for (const group of Object.values(MARKER_GROUPS)) for (const mm of group) mm.visible = false;
