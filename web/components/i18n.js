...
const UI_STRINGS = {
  'en-US': {
    ...
    statIsolated: 'Nodes with 0 links',
    statMaxDegree: 'Max degree',
    statMinDegree: 'Min degree',
    statLargestCommunity: 'Largest community',
    statMaxClustering: 'Max clustering',
    statDeepestCoreCount: 'In deepest core',
    statMaxPagerank: 'Max pagerank',
    ...
    modeBadgeClickHint: 'Click to cycle dataset mode (triples → wiki → combined)',
  ...
  'zh-TW': {
    ...
    statIsolated: '0 連結的節點',
    statMaxDegree: '最大度數',
    statMinDegree: '最小度數',
    statLargestCommunity: '最大社群',
    statMaxClustering: '最大聚類',
    statDeepestCoreCount: '最深核心內',
    statMaxPagerank: '最大 PageRank',
    ...
    modeBadgeClickHint: '點擊切換資料集模式 (triples → wiki → combined)',
