...
| IC₅₀ (COMT, human liver cytosol, 2-OH-E₂ methylation) | 3.3–4.5 µM | Zhu et al. 2004 (Drug Metab Dispos 32:497) |
| IC₅₀ (COMT, human liver cytosol, 4-OH-E₂ methylation) | 2.6–4.2 µM | Zhu et al. 2004 |
| Inhibition type | Mixed (competitive + noncompetitive) | Zhu et al. 2004 |
| MAO-A inhibition (IC₅₀) | 7.33 µM | Paudel et al. 2019 |
...
- The process consumes SAMe and generates S-adenosylhomocysteine (SAH), a potent feedback inhibitor of COMT
...
## Multi-Harmacology: Senolytic and COMT-Modulatory Axes
...
- **L-DOPA synergy (if applicable):** In Parkinson's disease models, COMT inhibition by fisetin could potentiate L-DOPA efficacy—analogous to entacapone but with additional senolytic benefits.

#### Potential Risks:

- **Catecholamine accumulation:** Excessive COMT inhibition could elevate epinephrine/norepinephrine, particularly under oxidative stress conditions, potentially increasing autoxidation to aminochromes (adrenochrome, dopaminochrome). This is a mechanistic concern, not an empirical observation at fisetin doses.
...
Fisetin has notoriously poor oral bioavailability:
...
| Nanosuspension | Improved (rat data) | ~225 nm particles |
...
- **Brain penetration** may achieve higher local concentrations due to fisetin's lipophilicity (log P = 3.2) and reported BBB crossing
...
- **Substrates:** Dopamine, norepinephrine, epinephrine, 2-OH-E₂, 4-OH-E₂
- **Methods:** Radiochemical assay with [³H]-SAMe; Michaelis-Menten and Lineweaver-Burk kinetic analysis
...
- **Cell models:** Senescent IMR-90 fibroblasts (etoposide-induced), primary senescent endothelial cells, senescent preadipocytes
...
- **Primary endpoints:** Epigenetic age (GrimAge, DunedinPACE), frailty index
...
Fisetin is a legitimate COMT inhibitor and COMT substrate with moderate potency (IC₅₀ ~3–6 µM). Its pharmacological profile is uniquely bifurcated:

- **At low concentrations (nM):** Primarily acts as a substrate for COMT (undergoes O-methylation to geraldol)
- **At intermediate concentrations (low µM):** Mixed-type COMT inhibition with MAO-A inhibition
...
**Bottom line:** Fisetin is worth investigating as a dual COMT modulator and senolytic, but the COMT axis has been almost entirely neglected in the longevity literature. A systematic pharmacogenomic investigation—beginning with mouse studies stratified by COMT genotype and measuring brain COMT activity directly—is essential before any claims about COMT-related mechanisms of fisetin's healthspan benefits can be made.
