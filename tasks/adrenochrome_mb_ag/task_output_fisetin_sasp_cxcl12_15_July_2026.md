...
2. **What is the mechanism by which fisetin reverses EndoMT in senescent endothelial cells?**
   - Crosses [[Fisetin]], [[Endothelial-to-Mesenchymal Transition]], and [[SASP]] communities
   - The [[TGFβ]]/[[ACTA2]] upregulation and [[CDH5]]/[[PECAM1]] downregulation suggest TGF-β pathway involvement
...
- [[Endothelial-to-Mesenchymal Transition]]: Transdifferentiation mechanism — blocked by fisetin
...
The following entities are referenced in this document but do not yet have wiki notes:

- [[CDH5]] (VE-cadherin) — vascular endothelial cadherin, downregulated 45% in EndoMT
- [[PECAM1]] (CD31) — platelet endothelial cell adhesion molecule, downregulated 55% in EndoMT
